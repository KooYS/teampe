 ...
 */
!function (e, a) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = a() : "function" == typeof define && define.amd ? define(a) : e.Dom7 = a()
}(this, function () {
    "use strict";
    function e(e, a) {
        var t = [], r = 0;
        ...
        if (e)if ("string" == typeof e) {
            ...
            } else for (n = a || "#" !== e[0] || e.match(/[ .<>:~]/) ? (a || document).querySelectorAll(e.trim()) : [document.getElementById(e.trim().split("#")[1])], r = 0; r < n.length; r += 1)n[r] && t.push(n[r])
        } else if (e.nodeType || e === window || e === document)t.push(e); else if (e.length > 0 && e[0].nodeType)for (r = 0; r < e.length; r += 1)t.push(e[r]);
        return new l(t)
    }
    ...
    function a(a) {
        function t(t, r, n) {
            var s = arguments;
            t && e(document).trigger(t, r), n && (n in i && i[n](s[3], s[4], s[5], s[6]), a[n] && a[n](s[3], s[4], s[5], s[6]))
        }
        ...
        var i = f;
        h.each(i, function (e, a) {
            n.indexOf(e) < 0 && (r[e] = a)
        }), h.each(r, function (e, t) {
            e in a || (a[e] = t)
        }), a.url || (a.url = window.location.toString());
        var s = a.url.indexOf("?") >= 0 ? "&" : "?", o = a.method.toUpperCase();
        if (("GET" === o || "HEAD" === o || "OPTIONS" === o || "DELETE" === o) && a.data) {
            var l;
            l = "string" == typeof a.data ? a.data.indexOf("?") >= 0 ? a.data.split("?")[1] : a.data : h.serializeObject(a.data), l.length && (a.url += s + l, "?" === s && (s = "&"))
        }
        if ("json" === a.dataType && a.url.indexOf("callback=") >= 0) {
            var p, d = "f7jsonp_" + (Date.now() + (g += 1)), c = a.url.split("callback="), m = c[0] + "callback=" + d;
            if (c[1].indexOf("&") >= 0) {
            ...
            return v.type = "text/javascript", v.onerror = function () {
                clearTimeout(p), t(void 0, void 0, "error", null, "scripterror"), t("ajaxComplete ajax:complete", {scripterror: !0}, "complete", null, "scripterror")
            }, v.src = m, window[d] = function (e) {
                clearTimeout(p), t(void 0, void 0, "success", e), v.parentNode.removeChild(v), v = null, delete window[d]
            }, document.querySelector("head").appendChild(v), void(a.timeout > 0 && (p = setTimeout(function () {
                v.parentNode.removeChild(v), v = null, t(void 0, void 0, "error", null, "timeout")
            }, a.timeout)))
        }
        "GET" !== o && "HEAD" !== o && "OPTIONS" !== o && "DELETE" !== o || !1 === a.cache && (a.url += s + "_nocache" + Date.now());
        var b = new XMLHttpRequest;
        b.requestUrl = a.url, b.requestParameters = a, b.open(o, a.url, a.async, a.user, a.password);
        var w = null;
        if (("POST" === o || "PUT" === o || "PATCH" === o) && a.data)if (a.processData) {
            var C = [ArrayBuffer, Blob, Document, FormData];
            if (C.indexOf(a.data.constructor) >= 0)w = a.data; else {
                var y = "---------------------------" + Date.now().toString(16);
                "multipart/form-data" === a.contentType ? b.setRequestHeader("Content-Type", "multipart/form-data; boundary=" + y) : b.setRequestHeader("Content-Type", a.contentType), w = "";
                var x = h.serializeObject(a.data);
                if ("multipart/form-data" === a.contentType) {
                    y = "---------------------------" + Date.now().toString(16), x = x.split("&");
                    for (var T = [], k = 0; k < x.length; k += 1)T.push('Content-Disposition: form-data; name="' + _data[k].split("=")[0] + '"\r\n\r\n' + _data[k].split("=")[1] + "\r\n");
                    w = "--" + y + "\r\n" + T.join("--" + y + "\r\n") + "--" + y + "--\r\n"
                } else w = x
            }
        } else w = a.data;
        a.headers && h.each(a.headers, function (e, a) {
            b.setRequestHeader(e, a)
        }), void 0 === a.crossDomain && (a.crossDomain = /^([\w-]+:)?\/\/([^\/]+)/.test(a.url) && RegExp.$2 !== window.location.host), a.crossDomain || b.setRequestHeader("X-Requested-With", "XMLHttpRequest"), a.xhrFields && h.each(a.xhrFields, function (e, a) {
            b[e] = a
        });
        var P;
        return b.onload = function (e) {
            if (P && clearTimeout(P), b.status >= 200 && b.status < 300 || 0 === b.status) {
                var r;
                if ("json" === a.dataType)try {
                    r = JSON.parse(b.responseText), t("ajaxSuccess ajax:success", {xhr: b}, "success", r, b.status, b)
                } catch (e) {
                    t("ajaxError ajax:error", {xhr: b, parseerror: !0}, "error", b, "parseerror")
                } else r = "text" === b.responseType || "" === b.responseType ? b.responseText : b.response, t("ajaxSuccess ajax:success", {xhr: b}, "success", r, b.status, b)
            } else t("ajaxError ajax:error", {xhr: b}, "error", b, b.status);
            a.statusCode && (i.statusCode && i.statusCode[b.status] && i.statusCode[b.status](b), a.statusCode[b.status] && a.statusCode[b.status](b)), t("ajaxComplete ajax:complete", {xhr: b}, "complete", b, b.status)
        }, b.onerror = function (e) {
            P && clearTimeout(P), t("ajaxError ajax:error", {xhr: b}, "error", b, b.status), t("ajaxComplete ajax:complete", {
                xhr: b,
                error: !0
            }, "complete", b, "error")
        }, t("ajaxStart ajax:start", {xhr: b}, "start", b), t(void 0, void 0, "beforeSend", b), a.timeout > 0 && (b.onabort = function () {
            P && clearTimeout(P)
        }, P = setTimeout(function () {
            b.abort(), t("ajaxError ajax:error", {
                xhr: b,
                timeout: !0
            }, "error", b, "timeout"), t("ajaxComplete ajax:complete", {xhr: b, timeout: !0}, "complete", b, "timeout")
        }, a.timeout)), b.send(w), b
    }
    ...
    function t(a) {
        ...
        if ("function" == typeof t[1]) {
            var p;
            p = t, n = p[0], s = p[1], o = p[2], l = p[3]
        } else {
            var d;
            d = t, n = d[0], i = d[1], s = d[2], o = d[3], l = d[4]
        }
        return [s, o].forEach(function (e) {
            "string" == typeof e && (l = e, e === s ? s = void 0 : o = void 0)
        }), l = l || ("getJSON" === a ? "json" : void 0), e.ajax({
            url: n,
            method: "post" === a ? "POST" : "GET",
            data: i,
            success: s,
            error: o,
            dataType: l
    ...
    function r() {
        ...
        return e.unshift("get"), t.apply(this, e)
    }

    function n() {
        for (var e = [], a = arguments.length; a--;)e[a] = arguments[a];
        return e.unshift("post"), t.apply(this, e)
    }

    function i() {
        for (var e = [], a = arguments.length; a--;)e[a] = arguments[a];
        return e.unshift("getJSON"), t.apply(this, e)
    }

    function s(a, t) {
        var r = this, n = {
            props: e.extend({}, a),
            params: e.extend({duration: 300, easing: "swing"}, t),
            elements: r,
            animating: !1,
            que: [],
            ...
            stop: function () {
                n.frameId && h.cancelAnimationFrame(n.frameId), n.animating = !1, n.elements.each(function (e, a) {
            ...
            animate: function (e, a) {
                function t() {
                    s = (new Date).getTime();
                    var m, u;
                    c || (c = !0, a.begin && a.begin(r)), null === l && (l = s), a.progress && a.progress(r, Math.max(Math.min((s - l) / a.duration, 1), 0), l + a.duration - s < 0 ? 0 : l + a.duration - s, l), i.forEach(function (t) {
                        var r = t;
                        o || r.done || Object.keys(e).forEach(function (t) {
                            if (!o && !r.done) {
                                m = Math.max(Math.min((s - l) / a.duration, 1), 0), u = n.easingProgress(a.easing, m);
                                var c = r[t], h = c.initialValue, f = c.finalValue, g = c.unit;
                                r[t].currentValue = h + u * (f - h);
                                var v = r[t].currentValue;
                                if ((f > h && v >= f || f < h && v <= f) && (r.container.style[t] = f + g, d += 1, d === Object.keys(e).length && (r.done = !0, p += 1), p === i.length && (o = !0)), o)return void n.done(a.complete);
                                r.container.style[t] = v + g
                            }
                        })
                    }), o || (n.frameId = h.requestAnimationFrame(t))
                }
                ...
                n.elements.each(function (a, t) {
                    var r, s, o, l, p;
                    t.dom7AnimateInstance || (n.elements[a].dom7AnimateInstance = n), i[a] = {container: t}, Object.keys(e).forEach(function (n) {
                ...
                var s, o, l = null, p = 0, d = 0, c = !1;
                return n.animating = !0, n.frameId = h.requestAnimationFrame(t), n
            }
        };
    ...
    }, p = [{base: "A", letters: "AⒶＡÀÁÂẦẤẪẨÃĀĂẰẮẴẲȦǠÄǞẢÅǺǍȀȂẠẬẶḀĄȺⱯ"}, {base: "AA", letters: "Ꜳ"}, {
        base: "AE",
        letters: "ÆǼǢ"
    ...
    }, {base: "L", letters: "LⓁＬĿĹĽḶḸĻḼḺŁȽⱢⱠꝈꝆꞀ"}, {base: "LJ", letters: "Ǉ"}, {base: "Lj", letters: "ǈ"}, {
        base: "M",
        letters: "MⓂＭḾṀṂⱮƜ"
    }, {base: "N", letters: "NⓃＮǸŃÑṄŇṆŅṊṈȠƝꞐꞤ"}, {base: "NJ", letters: "Ǌ"}, {base: "Nj", letters: "ǋ"}, {
        base: "O",
        letters: "OⓄＯÒÓÔỒỐỖỔÕṌȬṎŌṐṒŎȮȰÖȪỎŐǑȌȎƠỜỚỠỞỢỌỘǪǬØǾƆƟꝊꝌ"
    }, {base: "OI", letters: "Ƣ"}, {base: "OO", letters: "Ꝏ"}, {base: "OU", letters: "Ȣ"}, {
        base: "OE",
        letters: "Œ"
    }, {base: "oe", letters: "œ"}, {base: "P", letters: "PⓅＰṔṖƤⱣꝐꝒꝔ"}, {base: "Q", letters: "QⓆＱꝖꝘɊ"}, {
        base: "R",
    ...
    }, {base: "Z", letters: "ZⓏＺŹẐŻŽẒẔƵȤⱿⱫꝢ"}, {base: "a", letters: "aⓐａẚàáâầấẫẩãāăằắẵẳȧǡäǟảåǻǎȁȃạậặḁąⱥɐ"}, {
        base: "aa",
        letters: "ꜳ"
    }, {base: "ae", letters: "æǽǣ"}, {base: "ao", letters: "ꜵ"}, {base: "au", letters: "ꜷ"}, {
        base: "av",
        letters: "ꜹꜻ"
    }, {base: "ay", letters: "ꜽ"}, {base: "b", letters: "bⓑｂḃḅḇƀƃɓ"}, {base: "c", letters: "cⓒｃćĉċčçḉƈȼꜿↄ"}, {
        base: "d",
    ...
    }, {base: "t", letters: "tⓣｔṫẗťṭțţṱṯŧƭʈⱦꞇ"}, {base: "tz", letters: "ꜩ"}, {
        base: "u",
    ...
    }], d = {}, c = 0; c < p.length; c += 1)for (var m = p[c].letters, u = 0; u < m.length; u += 1)d[m[u]] = p[c].base;
    var h = {
        parseUrlQuery: function (e) {
            var a, t, r, n, i = {}, s = e || window.location.href;
            if ("string" == typeof s && s.length)for (s = s.indexOf("?") > -1 ? s.replace(/\S*\?/, "") : "", t = s.split("&").filter(function (e) {
                return "" !== e
        ...
        each: function (e, a) {
            if ("object" == typeof e && a)if (Array.isArray(e) || e instanceof l) {
                for (var t = 0; t < e.length; t++)if (!1 === a(t, e[t]))return
            } else for (var r in e)if (e.hasOwnProperty(r) && !1 === a(r, e[r]))return
        },
        unique: function (e) {
            for (var a = [], t = 0; t < e.length; t += 1)-1 === a.indexOf(e[t]) && a.push(e[t]);
            return a
        },
        serializeObject: function (e, a) {
            function t(e) {
                if (a.length > 0) {
            ...
            for (var s in e)if (e.hasOwnProperty(s)) {
                ...
                if (Array.isArray(e[s])) {
                    o = [];
                    for (var l = 0; l < e[s].length; l += 1)Array.isArray(e[s][l]) || "object" != typeof e[s][l] ? o.push(t(s) + "[]=" + r(e[s][l])) : (n = a.slice(), n.push(s), n.push(String(l)), o.push(h.serializeObject(e[s][l], n)));
                    o.length > 0 && i.push(o.join("&"))
                } else null === e[s] || "" === e[s] ? i.push(t(s) + "=") : "object" == typeof e[s] ? (n = a.slice(), n.push(s), "" !== (o = h.serializeObject(e[s], n)) && i.push(o)) : void 0 !== e[s] && "" !== e[s] ? i.push(t(s) + "=" + r(e[s])) : "" === e[s] && i.push(t(s))
            }
            return i.join("&")
        },
        ...
        extend: function () {
            ...
            for (var t = Object(e[0]), r = 1; r < e.length; r += 1) {
                var n = e[r];
                if (void 0 !== n && null !== n)for (var i = Object.keys(Object(n)), s = 0, o = i.length; s < o; s += 1) {
                    var l = i[s], p = Object.getOwnPropertyDescriptor(n, l);
                    void 0 !== p && p.enumerable && ("object" == typeof t[l] && "object" == typeof n[l] ? h.extend(t[l], n[l]) : t[l] = n[l])
                }
            }
            return t
        }
    };
    h.parseQuery = h.parseUrlQuery, h.param = h.serializeObject;
    var f = {};
    e.ajaxSetup = function (e) {
        e.type && !e.method && (e.method = e.type), h.each(e, function (e, a) {
            f[e] = a
        })
    };
    for (var g = 0, v = {
        scrollTo: function (e, a, t, r, n) {
            return void 0 === r && (r = "swing"), 4 === arguments.length && "function" == typeof r && (n = r, r = void 0), this.each(function () {
                function i(e) {
                    void 0 === e && (e = (new Date).getTime()), null === b && (b = e);
                    var a, l = Math.max(Math.min((e - b) / t, 1), 0), p = "linear" === r ? l : .5 - Math.cos(l * Math.PI) / 2;
                    if (g && (m = s + p * (d - s)), v && (u = o + p * (c - o)), g && d > s && m >= d && (f.scrollTop = d, a = !0), g && d < s && m <= d && (f.scrollTop = d, a = !0), v && c > o && u >= c && (f.scrollLeft = c, a = !0), v && c < o && u <= c && (f.scrollLeft = c, a = !0), a)return void(n && n());
                    g && (f.scrollTop = m), v && (f.scrollLeft = u), h.requestAnimationFrame(i)
                }

                var s, o, l, p, d, c, m, u, f = this, g = a > 0 || 0 === a, v = e > 0 || 0 === e;
                if (void 0 === r && (r = "swing"), g && (s = f.scrollTop, t || (f.scrollTop = a)), v && (o = f.scrollLeft, t || (f.scrollLeft = e)), t) {
                    g && (l = f.scrollHeight - f.offsetHeight, d = Math.max(Math.min(a, l), 0)), v && (p = f.scrollWidth - f.offsetWidth, c = Math.max(Math.min(e, p), 0));
                    var b = null;
                    g && d === s && (g = !1), v && c === o && (v = !1), h.requestAnimationFrame(i)
                }
            })
        }, scrollTop: function (e, a, t, r) {
            3 === arguments.length && "function" == typeof t && (r = t, t = void 0);
            var n = this;
            return void 0 === e ? n.length > 0 ? n[0].scrollTop : null : n.scrollTo(void 0, e, a, t, r)
        }, scrollLeft: function (e, a, t, r) {
            3 === arguments.length && "function" == typeof t && (r = t, t = void 0);
            var n = this;
        ...
        addClass: function (e) {
            ...
            for (var t = e.split(" "), r = 0; r < t.length; r += 1)for (var n = 0; n < this.length; n += 1)void 0 !== a[n].classList && a[n].classList.add(t[r]);
            return this
        }, removeClass: function (e) {
            for (var a = this, t = e.split(" "), r = 0; r < t.length; r += 1)for (var n = 0; n < this.length; n += 1)void 0 !== a[n].classList && a[n].classList.remove(t[r]);
            return this
        }, hasClass: function (e) {
            return !!this[0] && this[0].classList.contains(e)
        }, toggleClass: function (e) {
            for (var a = this, t = e.split(" "), r = 0; r < t.length; r += 1)for (var n = 0; n < this.length; n += 1)void 0 !== a[n].classList && a[n].classList.toggle(t[r]);
            return this
        }, attr: function (e, a) {
            var t = arguments, r = this;
            if (1 !== arguments.length || "string" != typeof e) {
                for (var n = 0; n < this.length; n += 1)if (2 === t.length)r[n].setAttribute(e, a); else for (var i in e)r[n][i] = e[i], r[n].setAttribute(i, e[i]);
                return this
            }
            ...
            var t = arguments, r = this;
            if (1 !== arguments.length || "string" != typeof e) {
                for (var n = 0; n < this.length; n += 1)if (2 === t.length)r[n][e] = a; else for (var i in e)r[n][i] = e[i];
                return this
            }
            ...
            if (e) {
                var a = {};
                if (e.dataset)for (var t in e.dataset)a[t] = e.dataset[t]; else for (var r = 0; r < e.attributes.length; r += 1) {
                    var n = e.attributes[r];
                    n.name.indexOf("data-") >= 0 && (a[h.toCamelCase(n.name.split("data-")[1])] = n.value)
                }
            ...
            function a(a) {
                var t = a.target, r = a.target.dom7EventData || [];
                if (r.unshift(a), e(t).is(s))o.apply(t, r); else for (var n = e(t).parents(), i = 0; i < n.length; i += 1)e(n[i]).is(s) && o.apply(n[i], r)
            }
            ...
            for (var d, c = l.split(" "), m = 0; m < this.length; m += 1) {
                var u = r[m];
                if (s)for (d = 0; d < c.length; d += 1)u.dom7LiveListeners || (u.dom7LiveListeners = []), u.dom7LiveListeners.push({
                    type: l,
                    listener: o,
                    proxyListener: a
                }), u.addEventListener(c[d], a, p); else for (d = 0; d < c.length; d += 1)u.dom7Listeners || (u.dom7Listeners = []), u.dom7Listeners.push({
                    type: l,
                    listener: o,
                    proxyListener: t
            ...
            for (var o = i.split(" "), l = 0; l < o.length; l += 1)for (var p = 0; p < this.length; p += 1) {
                var d = e[p];
                if (r) {
                    if (d.dom7LiveListeners)for (var c = 0; c < d.dom7LiveListeners.length; c += 1)n ? d.dom7LiveListeners[c].listener === n && d.removeEventListener(o[l], d.dom7LiveListeners[c].proxyListener, s) : d.dom7Listeners[c].type === o[l] && d.removeEventListener(o[l], d.dom7LiveListeners[c].proxyListener, s)
                } else if (d.dom7Listeners)for (var m = 0; m < d.dom7Listeners.length; m += 1)n ? d.dom7Listeners[m].listener === n && d.removeEventListener(o[l], d.dom7Listeners[m].proxyListener, s) : d.dom7Listeners[m].type === o[l] && d.removeEventListener(o[l], d.dom7Listeners[m].proxyListener, s)
            }
            return this
            ...
            for (var e = this, a = [], t = arguments.length; t--;)a[t] = arguments[t];
            for (var r = a[0].split(" "), n = a[1], i = 0; i < r.length; i += 1)for (var s = 0; s < this.length; s += 1) {
                var o = void 0;
                try {
                    o = new CustomEvent(r[i], {detail: n, bubbles: !0, cancelable: !0})
                } catch (e) {
            ...
            function a(i) {
                if (i.target === this)for (e.call(this, i), t = 0; t < r.length; t += 1)n.off(r[t], a)
            }

            var t, r = ["webkitTransitionEnd", "transitionend"], n = this;
            if (e)for (t = 0; t < r.length; t += 1)n.on(r[t], a);
            return this
        }, animationEnd: function (e) {
            function a(i) {
                for (e(i), t = 0; t < r.length; t += 1)n.off(r[t], a)
            }

            var t, r = ["webkitAnimationEnd", "animationend"], n = this;
            if (e)for (t = 0; t < r.length; t += 1)n.on(r[t], a);
            return this
        }, width: function () {
            ...
            if (this.length > 0) {
                var e = this[0], a = e.getBoundingClientRect(), t = document.body, r = e.clientTop || t.clientTop || 0, n = e.clientLeft || t.clientLeft || 0, i = e === window ? window.scrollY : e.scrollTop, s = e === window ? window.scrollX : e.scrollLeft;
                return {top: a.top + i - r, left: a.left + s - n}
            }
            return null
        }, hide: function () {
            ...
            for (var e = this, a = 0; a < this.length; a += 1)e[a].style.display = "block";
            return this
        }, styles: function () {
            ...
            if (1 === arguments.length) {
                if ("string" != typeof e) {
                    for (t = 0; t < this.length; t += 1)for (var n in e)r[t].style[n] = e[n];
                    return this
                }
            ...
            var a = this;
            if (!e)return this;
            for (var t = 0; t < this.length; t += 1)if (!1 === e.call(a[t], t, a[t]))return a;
            return this
        }, filter: function (e) {
            ...
            if ("string" == typeof a) {
                ...
                for (t = e(a), r = 0; r < t.length; r += 1)if (t[r] === n)return !0;
                return !1
            }
            if (a === document)return n === document;
            if (a === window)return n === window;
            if (a.nodeType || a instanceof l) {
                for (t = a.nodeType ? [a] : a, r = 0; r < t.length; r += 1)if (t[r] === n)return !0;
                return !1
            }
            return !1
        }, indexOf: function (e) {
            for (var a = this, t = 0; t < this.length; t += 1)if (a[t] === e)return t
        }, index: function () {
            var e, a = this[0];
            if (a) {
            ...
            if (void 0 === e)return this;
            var a, t = this.length;
            return e > t - 1 ? new l([]) : e < 0 ? (a = t + e, new l(a < 0 ? [] : [this[a]])) : new l([this[e]])
        }, append: function () {
            for (var e = this, a = [], t = arguments.length; t--;)a[t] = arguments[t];
            for (var r, n = 0; n < a.length; n += 1) {
                r = a[n];
                for (var i = 0; i < this.length; i += 1)if ("string" == typeof r) {
                    var s = document.createElement("div");
                    for (s.innerHTML = r; s.firstChild;)e[i].appendChild(s.firstChild)
                } else if (r instanceof l)for (var o = 0; o < r.length; o += 1)e[i].appendChild(r[o]); else e[i].appendChild(r)
            }
            return this
        }, appendTo: function (a) {
            ...
            } else if (e instanceof l)for (t = 0; t < e.length; t += 1)r[a].insertBefore(e[t], r[a].childNodes[0]); else r[a].insertBefore(e, r[a].childNodes[0]);
            return this
        }, prependTo: function (a) {
            return e(a).prepend(this), this
        }, insertBefore: function (a) {
            for (var t = this, r = e(a), n = 0; n < this.length; n += 1)if (1 === r.length)r[0].parentNode.insertBefore(t[n], r[0]); else if (r.length > 1)for (var i = 0; i < r.length; i += 1)r[i].parentNode.insertBefore(t[n].cloneNode(!0), r[i])
        }, insertAfter: function (a) {
            for (var t = this, r = e(a), n = 0; n < this.length; n += 1)if (1 === r.length)r[0].parentNode.insertBefore(t[n], r[0].nextSibling); else if (r.length > 1)for (var i = 0; i < r.length; i += 1)r[i].parentNode.insertBefore(t[n].cloneNode(!0), r[i].nextSibling)
        }, next: function (a) {
            return new l(this.length > 0 ? a ? this[0].nextElementSibling && e(this[0].nextElementSibling).is(a) ? [this[0].nextElementSibling] : [] : this[0].nextElementSibling ? [this[0].nextElementSibling] : [] : [])
        }, nextAll: function (a) {
            var t = [], r = this[0];
            if (!r)return new l([]);
            ...
            if (this.length > 0) {
                var t = this[0];
                return new l(a ? t.previousElementSibling && e(t.previousElementSibling).is(a) ? [t.previousElementSibling] : [] : t.previousElementSibling ? [t.previousElementSibling] : [])
            }
            return new l([])
        }, prevAll: function (a) {
            var t = [], r = this[0];
            ...
            for (var t = this, r = [], n = 0; n < this.length; n += 1)null !== t[n].parentNode && (a ? e(t[n].parentNode).is(a) && r.push(t[n].parentNode) : r.push(t[n].parentNode));
            return e(h.unique(r))
        }, parents: function (a) {
            for (var t = this, r = [], n = 0; n < this.length; n += 1)for (var i = t[n].parentNode; i;)a ? e(i).is(a) && r.push(i) : r.push(i), i = i.parentNode;
            return e(h.unique(r))
        }, closest: function (e) {
            var a = this;
            return void 0 === e ? new l([]) : (a.is(e) || (a = a.parents(e).eq(0)), a)
        }, find: function (e) {
            for (var a = this, t = [], r = 0; r < this.length; r += 1)for (var n = a[r].querySelectorAll(e), i = 0; i < n.length; i += 1)t.push(n[i]);
            return new l(t)
        }, children: function (a) {
            for (var t = this, r = [], n = 0; n < this.length; n += 1)for (var i = t[n].childNodes, s = 0; s < i.length; s += 1)a ? 1 === i[s].nodeType && e(i[s]).is(a) && r.push(i[s]) : 1 === i[s].nodeType && r.push(i[s]);
            return new l(h.unique(r))
        }, remove: function () {
    ...
    }), w = "click blur focus focusin focusout keyup keydown keypress submit change mousedown mousemove mouseup mouseenter mouseleave mouseout mouseover touchstart touchend touchmove resize scroll".split(" "), C = "resize scroll".split(" "), y = 0; y < w.length; y += 1)!function (a) {
        b[a] = function (t, r, n) {
            var i = this;
            if (void 0 === t) {
                for (var s = 0; s < this.length; s += 1)C.indexOf(a) < 0 && (a in i[s] ? i[s][a]() : e(i[s]).trigger(a));
                return this
            }
    ...
    return function () {
        return Object.keys(h).forEach(function (a) {
            ...
            l.prototype[e] = v[e]
        }), l.prototype.animate = s, l.prototype.stop = o, e.ajax = a, e.get = r, e.post = n, e.getJSON = i, e.fn = l.prototype, e
    }()
}), function (e, a) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = a() : "function" == typeof define && define.amd ? define(a) : e.Template7 = a()
}(this, function () {
    "use strict";
    function e(e) {
    ...
    function t(e) {
        return (void 0 !== s && s.escape ? s.escape(e) : e).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;")
    }

    function r(e) {
        var a, t, r, n = e.replace(/[{}#}]/g, "").split(" "), i = [];
        for (t = 0; t < n.length; t += 1) {
            var s = n[t], p = void 0, d = void 0;
            if (0 === t)i.push(s); else if (0 === s.indexOf('"') || 0 === s.indexOf("'"))if (p = 0 === s.indexOf('"') ? l : o, d = 0 === s.indexOf('"') ? '"' : "'", 2 === s.match(p).length)i.push(s); else {
                for (a = 0, r = t + 1; r < n.length; r += 1)if (s += " " + n[r], n[r].indexOf(d) >= 0) {
                    a = r, i.push(s);
                    break
                }
                a && (t = a)
            } else if (s.indexOf("=") > 0) {
                var c = s.split("="), m = c[0], u = c[1];
                if (p || (p = 0 === u.indexOf('"') ? l : o, d = 0 === u.indexOf('"') ? '"' : "'"), 2 !== u.match(p).length) {
                    for (a = 0, r = t + 1; r < n.length; r += 1)if (u += " " + n[r], n[r].indexOf(d) >= 0) {
                        a = r;
                        break
                    }
                    a && (t = a)
    ...
    function n(a) {
        ...
        for (t = 0; t < s.length; t += 1) {
            ...
            if ("" !== o)if (o.indexOf("{{") < 0)i.push({type: "plain", content: o}); else {
                ...
                var l = r(o), p = l[0], d = ">" === p, c = [], m = {};
                for (n = 1; n < l.length; n += 1) {
                    var u = l[n];
                    e(u) ? m[u[0]] = "false" !== u[1] && u[1] : c.push(u)
                }
                if (o.indexOf("{#") >= 0) {
                    var h = "", f = "", g = 0, v = void 0, b = !1, w = !1, C = 0;
                    for (n = t + 1; n < s.length; n += 1)if (s[n].indexOf("{{#") >= 0 && (C += 1), s[n].indexOf("{{/") >= 0 && (C -= 1), s[n].indexOf("{{#" + p) >= 0)h += s[n], w && (f += s[n]), g += 1; else if (s[n].indexOf("{{/" + p) >= 0) {
                        if (!(g > 0)) {
                            v = n, b = !0;
                            break
                        }
    ...
    var s;
    s = "undefined" != typeof window ? window : "undefined" != typeof global ? global : void 0;
    var o = new RegExp("'", "g"), l = new RegExp('"', "g"), p = function (e) {
        function a(e, a) {
            var t, r = a, n = 0;
            if (0 === e.indexOf("../")) {
                var i = r.split("_")[1] - n;
                n = e.split("../").length - 1, r = "ctx_" + (i >= 1 ? i : 1), t = e.split("../")[n].split(".")
            } else 0 === e.indexOf("@global") ? (r = "Template7.global", t = e.split("@global.")[1].split(".")) : 0 === e.indexOf("@root") ? (r = "root", t = e.split("@root.")[1].split(".")) : t = e.split(".");
            for (var s = 0; s < t.length; s += 1) {
                var o = t[s];
                0 === o.indexOf("@") ? s > 0 ? r += "[(data && data." + o.replace("@", "") + ")]" : r = "(data && data." + e.replace("@", "") + ")" : isFinite(o) ? r += "[" + o + "]" : "this" === o || o.indexOf("this.") >= 0 || o.indexOf("this[") >= 0 || o.indexOf("this(") >= 0 ? r = o.replace("this", a) : r += "." + o
            }
            return r
        }

        function t(e, t) {
            for (var r = [], n = 0; n < e.length; n += 1)/^['"]/.test(e[n]) ? r.push(e[n]) : /^(true|false|\d+)$/.test(e[n]) ? r.push(e[n]) : r.push(a(e[n], t));
            return r.join(", ")
        }
        ...
        function r(e, o) {
            ...
            if (void 0 === e && (e = i.template), void 0 === o && (o = 1), "string" != typeof e)throw new Error("Template7: Template must be a string");
            var d = n(e), c = "ctx_" + o;
            if (0 === d.length)return function () {
                return ""
            };
            var m = "";
            m += 1 === o ? "(function (" + c + ", data, root) {\n" : "(function (" + c + ", data) {\n",
            ...
            for (u = 0; u < d.length; u += 1) {
                ...
                if ("plain" !== h.type) {
                    ...
                    if ("variable" === h.type && (f = a(h.contextName, c), m += "r += c(" + f + ", " + c + ");"), "helper" === h.type)if (h.helperName in i.helpers)g = t(h.contextName, c), m += "r += (Template7.helpers." + h.helperName + ").call(" + c + ", " + (g && g + ", ") + "{hash:" + JSON.stringify(h.hash) + ", data: data || {}, fn: " + l(h, o + 1) + ", inverse: " + p(h, o + 1) + ", root: root});"; else {
                        if (h.contextName.length > 0)throw new Error('Template7: Missing helper: "' + h.helperName + '"');
                        f = a(h.helperName, c), m += "if (" + f + ") {", m += "if (isArray(" + f + ")) {", m += "r += (Template7.helpers.each).call(" + c + ", " + f + ", {hash:" + JSON.stringify(h.hash) + ", data: data || {}, fn: " + l(h, o + 1) + ", inverse: " + p(h, o + 1) + ", root: root});", m += "}else {", m += "r += (Template7.helpers.with).call(" + c + ", " + f + ", {hash:" + JSON.stringify(h.hash) + ", data: data || {}, fn: " + l(h, o + 1) + ", inverse: " + p(h, o + 1) + ", root: root});", m += "}}"
                    }
                } else m += "r +='" + h.content.replace(/\r/g, "\\r").replace(/\n/g, "\\n").replace(/'/g, "\\'") + "';"
            }
            return m += "\nreturn r;})", eval.call(s, m)
        }
    ...
    return p.prototype = {
        options: {}, partials: {}, helpers: {
            _partial: function (e, a) {
                var t = p.prototype.partials[e];
                if (!t || t && !t.template)return "";
                t.compiled || (t.compiled = new p(t.template).compile());
                var r = this;
                ...
                } else for (var o in n)s += 1, i += r.fn(n[o], {key: o});
                ...
                var t;
                return t = e.indexOf("return") >= 0 ? "(function(){" + e + "})" : "(function(){return (" + e + ")})", eval.call(this, t).call(this) ? a.fn(this, a.data) : a.inverse(this, a.data)
            }
        }
    }, i.registerHelper = function (e, a) {
        p.prototype.helpers[e] = a
    }, i.unregisterHelper = function (e) {
        p.prototype.helpers[e] = void 0, delete p.prototype.helpers[e]
    }, i.registerPartial = function (e, a) {
        p.prototype.partials[e] = {template: a}
    }, i.unregisterPartial = function (e) {
        p.prototype.partials[e] && (p.prototype.partials[e] = void 0, delete p.prototype.partials[e])
    }, i.compile = function (e, a) {
        return new p(e, a).compile()
    }, i.options = p.prototype.options, i.helpers = p.prototype.helpers, i.partials = p.prototype.partials, i
}), function () {
    "use strict";
    window.Framework7 = function (e) {
        function a() {
            var e, a = i(this), t = a[0].scrollTop, r = a[0].scrollHeight, n = a[0].offsetHeight, s = a[0].getAttribute("data-distance"), o = a.find(".virtual-list"), l = a.hasClass("infinite-scroll-top");
            if (s || (s = 50), "string" == typeof s && s.indexOf("%") >= 0 && (s = parseInt(s, 10) / 100 * n), s > n && (s = n), l)t < s && a.trigger("infinite"); else if (t + n >= r - s) {
        ...
        var o = function (e, a) {
            ...
            o.history = [];
            var m = c, u = r.params.pushStateSeparator, h = r.params.pushStateRoot;
            ...
            var v, b, w, C, y, x, T, k, P, S, M, I, E = !1, O = !1, D = {}, L = [], z = [], B = !0, N = [], A = [];
            if (o.handleTouchStart = function (e) {
                    B && o.params.swipeBackPage && !E && !r.swipeoutOpenedEl && o.allowPageChange && (O = !1, E = !0, v = void 0, D.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, D.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, C = (new Date).getTime(), P = o.params.dynamicNavbar && l.find(".navbar-inner").length > 1)
                    ...
                    if (E) {
                        ...
                        if (void 0 === v && (v = !!(v || Math.abs(t - D.y) > Math.abs(a - D.x))), v || e.f7PreventSwipeBack || r.preventSwipeBack)return void(E = !1);
                        if (!O) {
                            var n = !1;
                            b = l.width();
                            var s = i(e.target), p = s.hasClass("swipeout") ? s : s.parents(".swipeout");
                            p.length > 0 && (!r.rtl && p.find(".swipeout-actions-left").length > 0 && (n = !0), r.rtl && p.find(".swipeout-actions-right").length > 0 && (n = !0)), L = s.is(".page") ? s : s.parents(".page"), L.hasClass("no-swipeback") && (n = !0), z = l.find(".page-on-left:not(.cached)");
                            var d = D.x - l.offset().left > o.params.swipeBackPageActiveArea;
                            if (d = r.rtl ? D.x < l.offset().left - l[0].scrollLeft + b - o.params.swipeBackPageActiveArea : D.x - l.offset().left > o.params.swipeBackPageActiveArea, d && (n = !0), 0 !== z.length && 0 !== L.length || (n = !0), n)return void(E = !1);
                        ...
                        var c = r.rtl ? -1 : 1;
                        w = (a - D.x - o.params.swipeBackPageThreshold) * c, w < 0 && (w = 0);
                        var m = w / b, u = {
                            percentage: m,
                            activePage: L[0],
                            previousPage: z[0],
                        ...
                        var h = w * c, f = (w / 5 - b / 5) * c;
                        if (1 === r.device.pixelRatio && (h = Math.round(h), f = Math.round(f)), L.transform("translate3d(" + h + "px,0,0)"), o.params.swipeBackPageAnimateShadow && !r.device.android && (S[0].style.opacity = 1 - 1 * m), z.transform("translate3d(" + f + "px,0,0)"), o.params.swipeBackPageAnimateOpacity && (M[0].style.opacity = 1 - 1 * m), P) {
                            var g;
                            for (g = 0; g < y.length; g++)if (I = i(y[g]), I.is(".subnavbar.sliding") || (I[0].style.opacity = 1 - 1.3 * m), I[0].className.indexOf("sliding") >= 0) {
                            ...
                            for (g = 0; g < x.length; g++)if (I = i(x[g]), I.is(".subnavbar.sliding") || (I[0].style.opacity = 1.3 * m - .3), I[0].className.indexOf("sliding") >= 0) {
                    ...
                    if (E = !1, O = !1, 0 === w)return i([L[0], z[0]]).transform(""), void(P && (y.transform("").css({opacity: ""}), x.transform("").css({opacity: ""}), T && T.length > 0 && T.transform(""), k && T.length > 0 && k.transform("")));
                    var a = (new Date).getTime() - C, t = !1;
                    (a < 300 && w > 10 || a >= 300 && w > b / 2) && (L.removeClass("page-on-center").addClass("page-on-right"), z.removeClass("page-on-left").addClass("page-on-center"), P && (N.removeClass("navbar-on-center").addClass("navbar-on-right"), A.removeClass("navbar-on-left").addClass("navbar-on-center")), t = !0), i([L[0], z[0]]).transform("").addClass("page-transitioning"), P && (y.css({opacity: ""}).each(function () {
                    ...
                    var n = {activePage: L[0], previousPage: z[0], activeNavbar: N[0], previousNavbar: A[0]};
                    if (t) {
                    ...
                    L.transitionEnd(function () {
                        i([L[0], z[0]]).removeClass("page-transitioning"), P && (y.removeClass("page-transitioning").css({opacity: ""}), x.removeClass("page-transitioning").css({opacity: ""}), T && T.length > 0 && T.removeClass("page-transitioning"), k && k.length > 0 && k.removeClass("page-transitioning")), B = !0, o.allowPageChange = !0, t ? (r.params.pushState && o.main && history.back(), r.pageBackCallback("after", o, {
                            pageContainer: L[0],
                            url: s,
                            position: "center",
                            newPage: z,
                            ...
                            oldPage: L,
                            swipeBack: !0
                        }), r.router.afterBack(o, L, z), o.params.onSwipeBackAfterChange && o.params.onSwipeBackAfterChange(n), l.trigger("swipeBackAfterChange swipeback:afterchange", n)) : (o.params.onSwipeBackAfterReset && o.params.onSwipeBackAfterReset(n), l.trigger("swipeBackAfterReset swipeback:afterreset", n)), S && S.length > 0 && S.remove(), M && M.length > 0 && M.remove()
                    })
                }, o.attachEvents = function (e) {
                    var a = e ? "off" : "on", t = !("touchstart" !== r.touchEvents.start || !r.support.passiveListener) && {
                            passive: !0,
                            capture: !1
                        }, n = !!r.support.passiveListener && {passive: !1, capture: !1};
                    ...
                    load: function (e) {
                        ...
                        return r.router.load(o, {content: e})
                    }, reloadPage: function (e) {
                        return r.router.load(o, {url: e, reload: !0})
                    }, reloadContent: function (e) {
                        return r.router.load(o, {content: e, reload: !0})
                    }, reloadPreviousPage: function (e) {
                        return r.router.load(o, {url: e, reloadPrevious: !0, reload: !0})
                    }, reloadPreviousContent: function (e) {
                        return r.router.load(o, {content: e, reloadPrevious: !0, reload: !0})
                    }, refreshPage: function () {
                        var e = {url: o.url, reload: !0, ignoreCache: !0};
                        ...
                        var e = {url: o.history[o.history.length - 2], reload: !0, reloadPrevious: !0, ignoreCache: !0};
                ...
                var V = !r.params.pushStateNoAnimation && void 0, Y = history.state;
        ...
        r.addView = function (e, a) {
            ...
            var a = i(".popover.modal-in .view"), t = i(".popup.modal-in .view"), r = i(".panel.active .view"), n = i(".views"), s = n.children(".view");
            ...
            if (!t && n && (t = i(n).parent(".navbar")[0]), n && (!n.f7NavbarInitialized || !e || e.params.domCache)) {
                var s = {container: t, innerContainer: n}, o = a && a.f7PageData, l = {page: o, navbar: s};
                if (n.f7NavbarInitialized && (e && e.params.domCache || !e && i(t).parents(".popup, .popover, .intro-screen, .modal, .actions-modal, .picker-modal").length > 0))return r.reinitNavbar(t, n), r.pluginHook("navbarReinit", l), void i(n).trigger("navbarReinit navbar:reinit", l);
            ...
            var s, o = {container: t, innerContainer: n};
            a && (s = a.f7PageData);
            var l = {page: s, navbar: o};
            ...
            if (!r.params.material) {
                (e ? i(e).find(".navbar .navbar-inner:not(.cached)") : i(".navbar .navbar-inner:not(.cached)")).each(function () {
                    ...
                    if (!e.hasClass("cached")) {
                        var a, t, n = r.rtl ? e.find(".right") : e.find(".left"), s = r.rtl ? e.find(".left") : e.find(".right"), o = e.find(".center"), l = e.find(".subnavbar"), p = 0 === n.length, d = 0 === s.length, c = p ? 0 : n.outerWidth(!0), m = d ? 0 : s.outerWidth(!0), u = o.outerWidth(!0), h = e.styles(), f = e[0].offsetWidth - parseInt(h.paddingLeft, 10) - parseInt(h.paddingRight, 10), g = e.hasClass("navbar-on-left");
                        ...
                        var C = t;
                        r.rtl && p && d && o.length > 0 && (C = -C), o.css({left: C + "px"})
                    }
                })
            }
        ...
        var l = function (e, a) {
            ...
            var l = r.rtl ? "margin-left" : "margin-right", p = !1;
            o.setCancelButtonMargin = function () {
                ...
                var a = o.value;
                o.input.val("").trigger("change").focus(), o.triggerEvent("clearSearch searchbar:clear", "onClear", {previousQuery: a})
                ...
                if (!c || e.trim() !== c) {
                    ...
                    if (o.isVirtualList) {
                        ...
                        s = o.params.removeDiacritics ? i.removeDiacritics(e.trim().toLowerCase()).split(" ") : e.trim().toLowerCase().split(" "), o.searchList.find("li").removeClass("hidden-by-searchbar").each(function (e, a) {
                            ...
                            var e = i(this), a = o.params.ignore && e.is(o.params.ignore);
        ...
        var p = function (e, a) {
            ...
            var r = {textarea: null, maxHeight: null};
            a = a || {};
            ...
            if (s.params = a, s.container = i(e), 0 !== s.container.length)return s.textarea = s.params.textarea ? i(s.params.textarea) : s.container.find("textarea"), s.pageContainer = s.container.parents(".page").eq(0), s.pageContent = s.pageContainer.find(".page-content"), s.pageContentPadding = parseInt(s.pageContent.css("padding-bottom")), s.initialBarHeight = s.container[0].offsetHeight, s.initialAreaHeight = s.textarea[0].offsetHeight, s.sizeTextarea = function () {
                s.textarea.css({height: ""});
                var e = s.textarea[0].offsetHeight, a = e - s.textarea[0].clientHeight, t = s.textarea[0].scrollHeight;
                if (t + a > e) {
                    var r = t + a, n = s.initialBarHeight + (r - s.initialAreaHeight), i = s.params.maxHeight || s.container.parents(".view")[0].offsetHeight - 88;
                    ...
                    s.pageContent.length > 0 && (s.pageContent.css("padding-bottom", n + "px"),
                    0 === s.pageContent.find(".messages-new-first").length && o && s.pageContent.scrollTop(s.pageContent[0].scrollHeight - s.pageContent[0].offsetHeight))
                } else s.pageContent.length > 0 && (s.container.css({
                    height: "",
                    bottom: ""
                }), s.pageContent.css({"padding-bottom": ""}))
            }, s.clear = function () {
        ...
        r.messagebar = function (e, a) {
            ...
            var s = e;
            if (r.params.cacheIgnoreGetParameters && e.indexOf("?") >= 0 && (s = e.split("?")[0]), r.params.cache && !t && e.indexOf("nocache") < 0 && r.params.cacheIgnore.indexOf(s) < 0)for (var o = 0; o < r.cache.length; o++)if (r.cache[o].url === s && (new Date).getTime() - r.cache[o].time < r.params.cacheDuration)return n(r.cache[o].content), !1;
            return r.xhr = i.ajax({
                url: e, method: "GET", beforeSend: r.params.onAjaxStart, complete: function (e, a) {
        ...
        for (var d = "beforeInit init reinit beforeAnimation afterAnimation back afterBack beforeRemove".split(" "), c = 0; c < d.length; c++)r.pageCallbacks[d[c]] = {}, function (e) {
        ...
        r.triggerPageCallbacks = function (e, a, t) {
            ...
            if (a) {
                ...
                r.pluginHook("pageBeforeRemove", s), r.params.onPageBeforeRemove && r.params.onPageBeforeRemove(r, s), r.triggerPageCallbacks("beforeRemove", s.name, s), i(s.container).trigger("pageBeforeRemove page:beforeremove", {page: s}), s = null
            }
            ...
            if (s) {
                ...
                if (s.f7PageData = l, "after" === e && (r.pluginHook("pageAfterAnimation", l), r.params.onPageAfterAnimation && r.params.onPageAfterAnimation(r, l), r.triggerPageCallbacks("afterAnimation", l.name, l), i(l.container).trigger("pageAfterAnimation page:afteranimation", {page: l})), "before" === e) {
            ...
            _modalsSelector: ".popup, .modal, .popover, .actions-modal, .picker-modal, .intro-screen",
            ...
            prepareNavbar: function (e, a, t) {
                i(e).find(".sliding").each(function () {
                    var e = i(this), a = "right" === t ? this.f7NavbarRightOffset : this.f7NavbarLeftOffset;
            ...
            template7Render: function (e, a) {
                var t, n, o = a.url, l = a.content, p = a.content, d = a.context, c = a.contextName, m = a.template;
                if ("string" == typeof l ? o ? r.template7Cache[o] && !a.ignoreCache ? n = s.cache[o] : (n = s.compile(l), s.cache[o] = n) : n = s.compile(l) : m && (n = m), d)t = d, d && o && (e.contextCache[o] = d); else {
                    if (c)if (c.indexOf(".") >= 0) {
                    ...
                    if (!t && m && s.templates)for (var b in s.templates)s.templates[b] === m && (t = s.data[b]);
            ...
            var n, s, o, l, p, d, c, m, u, h = a.url, f = a.content, g = {content: a.content}, v = a.template, b = a.pageName, w = i(e.container), C = i(e.pagesContainer), y = a.animatePages, x = void 0 === h && f || v, T = a.pushState, k = a.pageElement;
            ...
            if (a.reload)s = o.eq(o.length - 1); else {
                if (o.length > 1) {
            ...
            if (r.params.pushState && !a.reloadPrevious && e.main) {
                void 0 === T && (T = !0);
                var M = r.params.pushStateRoot || "", I = a.reload ? "replaceState" : "pushState";
                T && (x || b ? x && f ? history[I]({
            ...
            if (e.params.uniqueHistory) {
                var D = e.history, L = h;
                if (e.params.uniqueHistoryIgnoreGetParameters)for (D = [], L = h.split("?")[0], l = 0; l < e.history.length; l++)D.push(e.history[l].split("?")[0]);
                D.indexOf(L) !== D.lastIndexOf(L) && (e.history = e.history.slice(0, D.indexOf(L)), e.history.push(h), O = !0)
            }
            ...
            if (a = a || {}, r.routerPreOptions && (a = r.routerPreOptions(e, a) || {}), !a.component || !r.componentLoader) {
                ...
                var n = a.url, s = a.content, o = a.pageName, l = a.pageElement;
            ...
            function s() {
                if (r.router.temporaryDom.innerHTML = "", "string" == typeof g || f && "string" == typeof g)r.router.temporaryDom.innerHTML = v.content; else if ("length" in g && g.length > 1)for (var a = 0; a < g.length; a++)i(r.router.temporaryDom).append(g[a]); else i(r.router.temporaryDom).append(g);
            ...
            function o() {
                ...
                if (e.params.dynamicNavbar && void 0 === h && (h = !(!c || 0 === c.length)), p.addClass("page-on-left").removeClass("cached"), h && (m = P.children(".navbar"), u = m.find(".navbar-inner:not(.cached)"), c.addClass("navbar-on-left").removeClass("cached")), x) {
                    var t, s;
                    if (t = i(M[M.length - 2]), h && (s = i(t[0] && t[0].f7RelatedNavbar || u[u.length - 2])), e.params.domCache && e.initialPages.indexOf(t[0]) >= 0)t.length && t[0] !== p[0] && t.addClass("cached"), h && s.length && s[0] !== c[0] && s.addClass("cached"); else {
                        var o = h && s.length;
            ...
            var l, p, d, c, m, u, h, f = a.url, g = a.content, v = {content: a.content}, b = a.template, w = a.animatePages, C = a.preloadOnly, y = a.pushState, x = (a.ignoreCache, a.force), T = a.pageName, k = a.pageElement, P = i(e.container), S = i(e.pagesContainer), M = S.children(".page:not(.cached)"), I = !0;
            ...
            if (a = a || {}, r.routerPreOptions && (a = r.routerPreOptions(e, a) || {}), a.component && r.componentLoader)try {
                ...
                if (p) {
                    ...
                    if (n && n in e.pageElementsCache)t(); else if (0 !== n.indexOf("#"))return void r.get(a.url, e, a.ignoreCache, function (a, r) {
                        if (r)return void(e.allowPageChange = !0);
                        t(a)
                    })
                }
            ...
            if (e.params.dynamicNavbar) {
                var o = i(e.container).children(".navbar").find(".navbar-inner:not(.cached)"), l = i(a[0].f7RelatedNavbar || o[1]);
            ...
            if (e.params.domCache && i(e.container).find(".page.cached").each(function () {
                    var a = i(this), t = a[0].f7PageData && a[0].f7PageData.url;
        ...
        r.modalStack = [], r.modalStackClearQueue = function () {
            ...
            if (r.params.modalTemplate)r._compiledTemplates.modal || (r._compiledTemplates.modal = s.compile(r.params.modalTemplate)), a = r._compiledTemplates.modal(e); else {
                var t = "";
                if (e.buttons && e.buttons.length > 0)for (var n = 0; n < e.buttons.length; n++)t += '<span class="modal-button' + (e.buttons[n].bold ? " modal-button-bold" : "") + (e.buttons[n].default_button ? " default" : "") + '">' + e.buttons[n].text + "</span>";
                var o = e.title ? '<div class="modal-title">' + e.title + "</div>" : "", l = e.text ? '<div class="modal-text">' + e.text + "</div>" : "", p = e.afterText ? e.afterText : "", d = e.buttons && 0 !== e.buttons.length ? "" : "modal-no-buttons", c = e.verticalButtons ? "modal-buttons-vertical" : "", u = e.buttons && e.buttons.length > 0 ? '<div class="modal-buttons modal-buttons-' + e.buttons.length + " " + c + '">' + t + "</div>" : "";
            ...
            return "function" == typeof a && (n = arguments[2], t = arguments[1], a = void 0), r.modal({
                text: e || "",
                title: void 0 === a ? r.params.modalTitle : a,
                buttons: [{text: r.params.modalButtonCancel, onClick: n}, {
            ...
            return "function" == typeof a && (n = arguments[2], t = arguments[1], a = void 0), r.modal({
                ...
                buttons: [{text: r.params.modalButtonCancel}, {text: r.params.modalButtonOk, bold: !0}],
                onClick: function (e, a) {
                    var r = i(e).find('.modal-text-input[name="modal-username"]').val(), s = i(e).find('.modal-text-input[name="modal-password"]').val();
            ...
            if (p) {
                ...
                if (r.params.modalActionsTemplate)r._compiledTemplates.actions || (r._compiledTemplates.actions = s.compile(r.params.modalActionsTemplate)), d = r._compiledTemplates.actions(a); else {
                    for (var h = "", f = 0; f < a.length; f++)for (var g = 0; g < a[f].length; g++) {
                        0 === g && (h += '<div class="actions-modal-group">');
                        var v = a[f][g], b = v.label ? "actions-modal-label" : "actions-modal-button";
            ...
            function o() {
                e.css({left: "", top: ""});
                var t, n, i, s = e.width(), o = e.height(), l = 0;
                ...
                var d = a.outerWidth(), c = a.outerHeight(), m = a.offset(), u = m.left - r.left, h = m.top - r.top, f = a.parents(".page");
                f.length > 0 && (h -= f[0].scrollTop);
                var g = 0, v = 0, b = 0, w = p ? "bottom" : "top";
                if (p)if (o < r.height - h - c ? (w = "bottom", g = h) : o < h ? (g = h - o + c, w = "top") : (w = "bottom", g = h), g <= 0 ? g = 8 : g + o >= r.height && (g = r.height - o - 8), v = u, v + s >= r.width - 8 && (v = u + d - s - 8), v < 8 && (v = 8), "top" === w && e.addClass("popover-on-top"), "bottom" === w && e.addClass("popover-on-bottom"), a.hasClass("floating-button-to-popover") && !e.hasClass("modal-in")) {
                    e.addClass("popover-floating-button");
                    var C = v + s / 2 - (u + d / 2), y = g + o / 2 - (h + c / 2);
            ...
            return e || (e = ".intro-screen"), void 0 === a && (a = !0), e = i(e), 0 !== e.length && (i(".intro-screen.modal-in:not(.modal-out)").length > 0 && !e.hasClass("modal-in") && r.closeModal(".intro-screen.modal-in:not(.modal-out)"), e.show(), r.openModal(e, a), e[0])
        }, r.openModal = function (e, a) {
            void 0 === a && (a = !0), e = i(e), e[a ? "removeClass" : "addClass"]("not-animated");
            var t = e.hasClass("modal"), n = e.hasClass("popover"), s = e.hasClass("popup"), o = e.hasClass("intro-screen"), l = e.hasClass("picker-modal"), p = e.hasClass("actions-modal"), d = "modal";
            ...
            if (!0 !== e.data("f7-modal-shown")) {
                ...
                }), t && (e.show(), e.css({marginTop: -Math.round(e.outerHeight() / 2) + "px"}));
                var m;
            ...
            if (void 0 === a && (a = !0), void 0 === (e = i(e || ".modal-in")) || 0 !== e.length) {
                ...
                if (!n || c || !e.hasClass("ignore-close-by-outside")) {
                    ...
                    return s ? m = i(".popup-overlay") : l && r.params.material ? m = i(".picker-modal-overlay") : l || (m = i(".modal-overlay")), s ? e.length === i(".popup.modal-in").length && m.removeClass("modal-overlay-visible") : m && m.length > 0 && m.removeClass("modal-overlay-visible"), m && m[a ? "removeClass" : "addClass"]("not-animated"), e.trigger("close " + d + ":close"), l && (i("body").removeClass("with-picker-modal"), i("body").addClass("picker-modal-closing")), !n || r.params.material ? (a ? e.removeClass("modal-in").addClass("modal-out").transitionEnd(function (a) {
                        if (e.hasClass("modal-out"))e.trigger("closed " + d + ":closed"); else if (e.trigger("opened " + d + ":opened"), n)return;
            ...
            function t() {
                l.transitionEnd(function (e) {
                    i(e.target).is(l) ? (n.hasClass("active") ? n.trigger("opened panel:opened") : n.trigger("closed panel:closed"), o.css({display: ""}), r.allowPanelOpen = !0) : t()
                })
            }
            ...
            n[a ? "removeClass" : "addClass"]("not-animated"), n.css({display: "block"}).addClass("active"), n.trigger("open panel:open");
            ...
            return a ? t() : (n.trigger("opened panel:opened"), o.css({display: ""}), r.allowPanelOpen = !0), i("body").addClass("with-panel-" + e + "-" + s), !0
        }, r.closePanel = function (e) {
            void 0 === e && (e = !0);
            var a = i(".panel.active");
            if (0 === a.length || a.hasClass("panel-visible-by-breakpoint"))return !1;
            var t = a.hasClass("panel-reveal") ? "reveal" : "cover", n = a.hasClass("panel-left") ? "left" : "right";
            ...
            function e(e) {
                if (r.allowPanelOpen && (r.params.swipePanel || r.params.swipePanelOnlyClose) && !o && !(i(".modal-in, .photo-browser-in").length > 0) && (r.params.swipePanelCloseOpposite || r.params.swipePanelOnlyClose || !(i(".panel.active").length > 0) || n.hasClass("active")) && !(e.target && "input" === e.target.nodeName.toLowerCase() && "range" === e.target.type || i(e.target).closest(".tabs-swipeable-wrap").length > 0)) {
                    if (w.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, w.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, r.params.swipePanelCloseOpposite || r.params.swipePanelOnlyClose) {
                        if (i(".panel.active").length > 0)s = i(".panel.active").hasClass("panel-left") ? "left" : "right"; else {
            ...
            function t(e) {
                ...
                o = !1, l = !1;
                var a, t = (new Date).getTime() - d, p = 0 === m || Math.abs(m) === f;
                if (a = h ? "cover" === g ? 0 === m ? "reset" : t < 300 && Math.abs(m) > 0 ? "swap" : t >= 300 && Math.abs(m) < f / 2 ? "reset" : "swap" : m === -f ? "reset" : t < 300 && Math.abs(m) >= 0 || t >= 300 && Math.abs(m) <= f / 2 ? "left" === s && m === f ? "reset" : "swap" : "reset" : "cover" === g ? 0 === m ? "swap" : t < 300 && Math.abs(m) > 0 ? "swap" : t >= 300 && Math.abs(m) < f / 2 ? "swap" : "reset" : 0 === m ? "reset" : t < 300 && Math.abs(m) > 0 || t >= 300 && Math.abs(m) >= f / 2 ? "swap" : "reset", "swap" === a && (r.allowPanelOpen = !0, h ? (r.closePanel(), p && (n.css({display: ""}), i("body").removeClass("panel-closing"))) : r.openPanel(s), p && (r.allowPanelOpen = !0)), "reset" === a)if (h)r.allowPanelOpen = !0, r.openPanel(s); else if (r.closePanel(), p)r.allowPanelOpen = !0, n.css({display: ""}); else {
                    ...
                    n.trigger("close panel:close"), i("body").addClass("panel-closing"), c.transitionEnd(function () {
                        n.hasClass("active") || (n.trigger("close panel:closed"), n.css({display: ""}), i("body").removeClass("panel-closing"), r.allowPanelOpen = !0)
                    })
                }
            ...
            var o, l, p, d, c, m, u, h, f, g, v, b = i(".panel-overlay"), w = {}, C = i("." + r.params.viewsClass), y = !("touchstart" !== r.touchEvents.start || !r.support.passiveListener) && {
                    passive: !0,
                    capture: !1
                }, x = !!r.support.passiveListener && {passive: !1, capture: !1};
            ...
            function a(e) {
                ...
                e = i(e);
                var s = e.attr("data-background"), o = s || e.attr("data-src");
                if (o) {
        ...
        var u = function (e, a) {
            ...
            if (n.params = a, n.container = i(e), 0 !== n.container.length)return n.params.autoLayout && n.container.addClass("messages-auto-layout"), n.params.newMessagesFirst && n.container.addClass("messages-new-first"), n.pageContainer = n.container.parents(".page").eq(0), n.pageContent = n.pageContainer.find(".page-content"), n.template = Template7.compile(n.params.messageTemplate), n.layout = function () {
                n.container.hasClass("messages-auto-layout") || n.container.addClass("messages-auto-layout"), n.container.find(".message").each(function () {
                    ...
                    var e = i(this), a = e.hasClass("message-sent"), t = e.next(".message-" + (a ? "sent" : "received")), r = e.prev(".message-" + (a ? "sent" : "received"));
                ...
                var o = n.pageContent[0].scrollHeight, l = n.pageContent[0].offsetHeight, p = n.pageContent[0].scrollTop;
                if (n.container[a](i), n.params.autoLayout && n.layout(), "prepend" === a && (n.pageContent[0].scrollTop = p + (n.pageContent[0].scrollHeight - o)), n.params.scrollMessages && "append" === a && !n.params.newMessagesFirst || "prepend" === a && n.params.newMessagesFirst)if (n.params.scrollMessagesOnlyOnEdge) {
                    var d = !1;
                ...
                var m = [];
                if ("append" === a)for (r = c.length - e.length; r < c.length; r++)m.push(c[r]); else for (r = 0; r < e.length; r++)m.push(c[r]);
                return m
                ...
                if (void 0 !== a)t = a; else if ((t = n.params.newMessagesFirst ? 0 : n.pageContent[0].scrollHeight - n.pageContent[0].offsetHeight) === r)return;
        ...
        r.messages = function (e, a) {
            ...
            function n(e) {
                ...
                if (n = "to-left" === x ? u : h, t = "to-left" === x ? g : f, a = T < 300 && (d < -10 && "to-left" === x || d > 10 && "to-right" === x) || T >= 300 && Math.abs(v) > t / 2 ? "open" : "close", T < 300 && (0 === Math.abs(v) && (a = "close"), Math.abs(v) === t && (a = "open")), "open" === a) {
                    ...
                    var k = "to-left" === x ? -t : t;
                    if (m.transform("translate3d(" + k + "px,0,0)"), n.addClass("swipeout-actions-opened"), l = "to-left" === x ? y : C)for (w = 0; w < l.length; w++)i(l[w]).transform("translate3d(" + k + "px,0,0)");
                ...
                var M;
                if (C && C.length > 0 && C !== l)for (w = 0; w < C.length; w++)M = C[w]._buttonOffset, void 0 === M && (C[w]._buttonOffset = f - C[w].offsetLeft - C[w].offsetWidth), i(C[w]).transform("translate3d(" + M + "px,0,0)");
                if (y && y.length > 0 && y !== l)for (w = 0; w < y.length; w++)M = y[w]._buttonOffset, void 0 === M && (y[w]._buttonOffset = y[w].offsetLeft), i(y[w]).transform("translate3d(" + -M + "px,0,0)");
            ...
            var s, o, l, p, d, c, m, u, h, f, g, v, b, w, C, y, x, T, k, P, S, M, I, E = {}, O = !!r.support.passiveListener && {
                    passive: !1,
                    capture: !1
                };
            ...
            if (e = i(e), 2 === arguments.length && "function" == typeof arguments[1] && (t = a), 0 !== e.length && (e.length > 1 && (e = i(e[0])), e.hasClass("swipeout") && !e.hasClass("swipeout-opened"))) {
                ...
                if (0 !== n.length) {
                    ...
                    var s, o = n.children("a"), l = n.outerWidth(), p = "right" === a ? -l : l;
                    if (o.length > 1) {
            ...
            if (e = i(e), 0 !== e.length && e.hasClass("swipeout-opened")) {
                var n = e.find(".swipeout-actions-opened").hasClass("swipeout-actions-right") ? "right" : "left", s = e.find(".swipeout-actions-opened").removeClass("swipeout-actions-opened"), o = s.children("a"), l = s.outerWidth();
                ...
                for (var d = 0; d < o.length; d++)"right" === n ? i(o[d]).transform("translate3d(" + -o[d].offsetLeft + "px,0,0)") : i(o[d]).transform("translate3d(" + (l - o[d].offsetWidth - o[d].offsetLeft) + "px,0,0)"), i(o[d]).css({left: "0px"}).removeClass("swipeout-overswipe-active");
                r.swipeoutOpenedEl && r.swipeoutOpenedEl[0] === e[0] && (r.swipeoutOpenedEl = void 0)
            }
        }, r.swipeoutDelete = function (e, a) {
            if (e = i(e), 0 !== e.length) {
                e.length > 1 && (e = i(e[0])), r.swipeoutOpenedEl = void 0, e.trigger("delete swipeout:delete"), e.css({height: e.outerHeight() + "px"});
                e[0].clientLeft;
            ...
            function a(e) {
                if (n && p) {
                    ...
                    t < -m && (t = -m), t > u && (t = u), p.transform("translate3d(0," + t + "px,0)"), f = h = void 0, c.each(function () {
                        var e = i(this);
                        if (e[0] !== p[0]) {
                            var a = e[0].offsetTop, r = e.height(), n = p[0].offsetTop + t;
            ...
            var n, s, o, l, p, d, c, m, u, h, f, g, v, b = !!r.support.passiveListener && {passive: !1, capture: !1};
                ...
                if (0 !== a.length) {
                    ...
                    if (0 !== t.length) {
                        ...
                        if (0 === o.length)e.find(".item-inner").append('<div class="item-after">' + n.join(", ") + "</div>"); else {
                            var l = o.text();
                            if (o.hasClass("smart-select-value"))for (s = 0; s < t.length; s++)t[s].selected = t[s].textContent.trim() === l.trim(); else o.text(n.join(", "))
                        }
                        a.on("change", function () {
                            for (var a = [], r = 0; r < t.length; r++)if (t[r].selected) {
            ...
            if (e = i(e), 0 !== e.length) {
                ...
                if (0 !== p.length) {
                    ...
                    var c, m = e.dataset(), u = m.pageTitle || e.find(".item-title").text(), h = m.backText || r.params.smartSelectBackText;
                    ...
                    var f = void 0 !== m.backOnSelect ? m.backOnSelect : r.params.smartSelectBackOnSelect, g = m.formTheme || r.params.smartSelectFormTheme, v = m.navbarTheme || r.params.smartSelectNavbarTheme, b = m.toolbarTheme || r.params.smartSelectToolbarTheme, w = m.virtualList, C = m.virtualListHeight, y = r.params.material, x = m.pickerHeight || r.params.smartSelectPickerHeight, T = e.find("select")[0], k = i(T), P = k.dataset();
                    if (!(T.disabled || e.hasClass("disabled") || k.hasClass("disabled"))) {
                        for (var S, M, I, E, O, D, L, z, B, N, A, H = [], R = (new Date).getTime(), V = T.multiple ? "checkbox" : "radio", Y = V + "-" + R, q = k.attr("maxlength"), F = T.name, j = 0; j < T.length; j++)S = i(T[j]), A = S.dataset(), I = A.optionImage || P.optionImage || m.optionImage, E = A.optionIcon || P.optionIcon || m.optionIcon, M = I || E || "checkbox" === V, y && (M = I || E), B = A.optionColor, N = A.optionClass, S[0].disabled && (N += " disabled"), O = S.parent("optgroup")[0], D = O && O.label, L = !1, O && O !== z && (L = !0, z = O, H.push({
                            groupLabel: D,
                            isLabel: L
                        })), H.push({
                            value: S[0].value,
                        ...
                        var W = r._compiledTemplates.smartSelectItem, X = "";
                        if (!w)for (var G = 0; G < H.length; G++)X += W(H[G]);
                        var _, U, Q = "", J = "", K = "", Z = "";
                        "picker" === d ? (r._compiledTemplates.smartSelectToolbar || (r._compiledTemplates.smartSelectToolbar = s.compile(r.params.smartSelectToolbarTemplate || '<div class="toolbar {{#if toolbarTheme}}theme-{{toolbarTheme}}{{/if}}"><div class="toolbar-inner"><div class="left"></div><div class="right"><a href="#" class="link close-picker"><span>{{closeText}}</span></a></div></div></div>')), Q = r._compiledTemplates.smartSelectToolbar({
                            pageTitle: u,
                            closeText: c,
                            openIn: d,
                            toolbarTheme: b,
                        ...
                        }), "page" === d ? (U = "static", e.parents(".navbar-through").length > 0 && (U = "through"), e.parents(".navbar-fixed").length > 0 && (U = "fixed"), K = e.parents(".page").hasClass("no-toolbar") ? "no-toolbar" : "", J = e.parents(".page").hasClass("no-navbar") ? "no-navbar" : "navbar-" + U, Z = e.parents(".page").hasClass("no-tabbar") ? "no-tabbar" : "") : U = "fixed");
                        var $, ee, ae = "smart-select-" + Y, te = void 0 === e.data("searchbar") ? r.params.smartSelectSearchbar : "true" === e.data("searchbar");
                        te && ($ = e.data("searchbar-placeholder") || "Search", ee = e.data("searchbar-cancel") || "Cancel");
                        var re, ne, ie = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + R + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + $ + '"><a href="#" class="searchbar-clear"></a></div>' + (y ? "" : '<a href="#" class="searchbar-cancel">' + ee + "</a>") + '</form><div class="searchbar-overlay"></div>', se = ("picker" !== d && "through" === U ? _ : "") + '<div class="pages">  <div data-page="' + ae + '" data-select-name="' + F + '" class="page smart-select-page ' + J + " " + K + " " + Z + '">' + ("picker" !== d && "fixed" === U ? _ : "") + (te ? ie : "") + '    <div class="page-content">' + ("picker" !== d && "static" === U ? _ : "") + '      <div class="list-block ' + (w ? "virtual-list" : "") + " smart-select-list-" + R + " " + (g ? "theme-" + g : "") + '">        <ul>' + (w ? "" : X) + "        </ul>      </div>    </div>  </div></div>";
                        "popup" === d ? (a ? (re = i(".popup.smart-select-popup .view"), re.html(se)) : (re = r.popup('<div class="popup smart-select-popup smart-select-popup-' + Y + '"><div class="view navbar-fixed">' + se + "</div></div>"), re = i(re)), r.initPage(re.find(".page")), o(re)) : "picker" === d ? (a ? (ne = i(".picker-modal.smart-select-picker .view"), ne.html(se)) : (ne = r.pickerModal('<div class="picker-modal smart-select-picker smart-select-picker-' + Y + '"' + (x ? ' style="height:' + x + '"' : "") + ">" + Q + '<div class="picker-modal-inner"><div class="view">' + se + "</div></div></div>"), ne = i(ne), function () {
                            var a = e.parents(".page-content");
                            if (0 !== a.length) {
                                var t, r = parseInt(a.css("padding-top"), 10), n = parseInt(a.css("padding-bottom"), 10), i = a[0].offsetHeight - r - ne.height(), s = a[0].scrollHeight - r - ne.height(), o = e.offset().top - r + e[0].offsetHeight;
                                if (o > i) {
                                    var l = a.scrollTop() + o - i;
                                    l + i > s && (t = l + i - s + n, i === s && (t = ne.height()), a.css({"padding-bottom": t + "px"})), a.scrollTop(l, 300)
                                }
                            }
                        }(), i("html").on("click", t), ne.once("picker:close", function () {
                            e[0].f7SmartSelectPicker = void 0, i("html").off("click", t), e.parents(".page-content").css({paddingBottom: ""})
        ...
        var h = function (e, a) {
            ...
            var p, d, c, m, u, h, f = 0, g = "function" == typeof o.params.height;
            return o.setListSize = function () {
                ...
                if (void 0 !== a && (t = a), null === o.lastRepaintY || Math.abs(t - o.lastRepaintY) > f || !l && o.pageContent[0].scrollTop + p >= o.pageContent[0].scrollHeight) {
                    o.lastRepaintY = t;
                    var r, n, i = o.filteredItems || o.items, s = 0, d = 0;
                    if (g) {
                        var m, v, b = 0;
                ...
                var a, t = 0;
                if (g)for (var r = 0; r < e; r++)t += o.heights[r]; else t = e * o.params.height;
                ...
                if (e !== a) {
                    ...
                    if (a >= o.items.length ? (o.items.push(t), a = o.items.length - 1) : o.items.splice(a, 0, t), o.params.cache) {
                        ...
                        for (var n in o.domCache) {
                            var i = parseInt(n, 10), s = e < a ? e : a, l = e < a ? a : e, p = e < a ? -1 : 1;
        ...
        r.virtualList = function (e, a) {
            ...
            function t(e) {
                if (d) {
                    var a, t, n;
                    if ("touchmove" === e.type) {
                        if (p && e.touches)for (var i = 0; i < e.touches.length; i++)e.touches[i].identifier === p && (n = e.touches[i]);
            ...
            function n(e) {
                if (!("touchend" === e.type && e.changedTouches && e.changedTouches.length > 0 && p && e.changedTouches[0].identifier !== p)) {
                    ...
                    g && (f.addClass("transitioning"), g = 0), f.transform(""), T ? (f.addClass("refreshing"), f.trigger("refresh ptr:refresh", {
                        done: function () {
                            r.pullToRefreshDone(f)
                        }
                    })) : f.removeClass("pull-down"), d = !1, c = !1, y && f.trigger("pullend ptr:pullend")
                }
            }
            ...
            if (l.hasClass("pull-to-refresh-content") || (l = l.find(".pull-to-refresh-content")), l && 0 !== l.length) {
                var p, d, c, m, u, h, f, g, v, b, w, C, y, x = {}, T = !1, k = !1, P = 0, S = l.hasClass("page") ? l : l.parents(".page"), M = !1;
                ...
                var I = !("touchstart" !== r.touchEvents.start || !r.support.passiveListener) && {
                        passive: !0,
                        capture: !1
                    }, E = !!r.support.passiveListener && {passive: !1, capture: !1};
            ...
            if (0 !== t.length) {
                ...
                if (n || s || o) {
                    ...
                    if (0 !== l.length) {
                        ...
                        var m, u, h = d.length > 0, f = c.length > 0, g = p && p.length > 0;
                        m = u = t[0].scrollTop;
                        var v, b, w, C, y, x, T, k = f && s ? c[0].offsetHeight : 0, P = g && o ? p[0].offsetHeight : 0, S = P || k;
            ...
            i(e).each(function () {
                ...
                if ((a = a || e.find(".tab-link.active")) && a.length > 0) {
                    var t, n;
                    e.hasClass("tabbar-scrollable") ? (t = a[0].offsetWidth + "px", n = a[0].offsetLeft + "px") : (t = 1 / e.find(".tab-link").length * 100 + "%", n = 100 * (r.rtl ? -a.index() : a.index()) + "%"), e.find(".tab-link-highlight").css({width: t}).transform("translate3d(" + n + ",0,0)")
                }
            })
            ...
            n.length > 0 && r.accordionClose(n), t.css("height", t[0].scrollHeight + "px").transitionEnd(function () {
                if (e.hasClass("accordion-item-expanded")) {
                    ...
                    t[0].clientLeft;
                    t.transition(""),
                        e.trigger("opened accordion:opened")
            ...
            function e(e) {
                var a, t = i(e), n = t.parents(r.params.activeStateElements);
            ...
            function h(e) {
                var a = r.params.materialRippleElements, t = i(e);
            ...
            function f(e, a, t) {
                if (t) {
                    var r = t[0].getBoundingClientRect(), n = {
                        x: e - r.left,
                        y: a - r.top
                    }, s = r.height, o = r.width, l = Math.max(Math.pow(Math.pow(s, 2) + Math.pow(o, 2), .5), 48);
                    ...
                    q[0].clientLeft;
                    j = "translate3d(" + (o / 2 - n.x) + "px, " + (s / 2 - n.y) + "px, 0) scale(1)", q.transform(j)
                }
            }

            function g() {
                if (q) {
                    var e = q, a = setTimeout(function () {
                        e.remove()
                    }, 400);
                    q.addClass("ripple-wave-fill").transform(j.replace("scale(1)", "scale(1.01)")).transitionEnd(function () {
                        clearTimeout(a);
                        var e = i(this).addClass("ripple-wave-out").transform(j.replace("scale(1)", "scale(1.01)"));
            ...
            function w() {
                q ? g() : F && !B ? (clearTimeout(W), f(S, M, F), setTimeout(g, 0)) : g()
            }

            function C(e) {
                var a = e.changedTouches[0], t = document.createEvent("MouseEvents"), n = "click";
                r.device.android && "select" === E.nodeName.toLowerCase() && (n = "mousedown"), t.initMouseEvent(n, !0, !0, window, 1, a.screenX, a.screenY, a.clientX, a.clientY, !1, !1, !1, !1, 0, null), t.forwardedTouchEvent = !0, E.dispatchEvent(t)
            }
            ...
            function y(s) {
                ...
                r.device.android && o(s.target) && document.activeElement.blur(), O = !0, E = s.target, I = (new Date).getTime(), S = s.targetTouches[0].pageX, M = s.targetTouches[0].pageY, r.device.ios && (L = void 0, i(E).parents().each(function () {
                    var e = this;
            ...
            function x(e) {
                if (O) {
                    ...
                    if (t) {
                        var i = e.targetTouches[0].pageX, s = e.targetTouches[0].pageY;
            ...
            function T(e) {
                if (clearTimeout(R), clearTimeout(A), !O)return !D && V && (r.device.android && !e.cancelable || e.preventDefault()), !0;
                if (document.activeElement === e.target)return r.params.activeState && n(), r.params.material && r.params.materialRipple && w(), !0;
                if (D || e.preventDefault(), e.timeStamp - z < r.params.fastClicksDelayBetweenClicks)return setTimeout(n, 0), !0;
                if (z = e.timeStamp, O = !1, r.device.ios && L && L.scrollTop !== L.f7ScrollTop)return !1;
            ...
            var S, M, I, E, O, D, L, z, B, N, A, H, R, V, Y, q, F, j, W;
            ...
            function a(e) {
                var a = i(this), t = a.attr("href"), n = "a" === a[0].nodeName.toLowerCase();
                ...
                var h;
                if (a.hasClass("tab-link") && (h = !0, r.showTab(l.tab || a.attr("href"), a)), a.hasClass("swipeout-close") && r.swipeoutClose(a.parents(".swipeout-opened")), a.hasClass("swipeout-delete"))if (l.confirm) {
                    var f = l.confirm, g = l.confirmTitle;
                ...
                if (a.hasClass("floating-button") && a.parent().hasClass("speed-dial") && a.parent().toggleClass("speed-dial-opened"), a.hasClass("close-speed-dial") && i(".speed-dial-opened").removeClass("speed-dial-opened"), (!r.params.ajaxLinks || a.is(r.params.ajaxLinks)) && n && r.params.router) {
                    n && e.preventDefault();
                    var b = t && t.length > 0 && "#" !== t && !h, w = l.template;
        ...
        r.getSize = function () {
            ...
            var a = {}, t = ["submit", "image", "button", "file"], r = [];
            return e.find("input, select, textarea").each(function () {
                var n = i(this), s = n.attr("name"), o = n.attr("type"), l = this.nodeName.toLowerCase();
                if (!(t.indexOf(o) >= 0) && !(r.indexOf(s) >= 0) && s)if ("select" === l && n.prop("multiple"))r.push(s), a[s] = [], e.find('select[name="' + s + '"] option').each(function () {
            ...
            }), e.trigger("formToJSON formToData form:todata", {formData: a}), a
        }, r.formToJSON = r.formToData, r.formFromData = function (e, a) {
            if (e = i(e), 1 !== e.length)return !1;
            var t = ["submit", "image", "button", "file"], r = [];
            ...
            }), e.trigger("formFromJSON formFromData form:fromdata", {formData: a})
        }, r.formFromJSON = r.formFromData, r.initFormsStorage = function (e) {
            function a() {
                var e = i(this), a = e[0].id;
                if (a) {
                    var t = r.formToData(e);
                    t && (r.formStoreData(a, t), e.trigger("store form:storedata", {data: t}))
                }
            }
            ...
            if ("change" !== e.type || a.hasClass("ajax-submit-onchange")) {
                ...
                var t = (a.attr("method") || "GET").toUpperCase(), n = a.prop("enctype") || a.attr("enctype"), s = a.attr("action");
                if (s) {
                    var o;
                    o = "POST" === t ? new FormData(a[0]) : i.serializeObject(r.formToJSON(a[0]));
                    var l = i.ajax({
                        method: t, url: s, contentType: n, data: o, beforeSend: function (e) {
                            a.trigger("beforeSubmit form:beforesend", {data: o, xhr: e})
                        }, error: function (e) {
                            a.trigger("submitError form:error", {data: o, xhr: e})
                        }, success: function (e) {
                            a.trigger("submitted form:success", {data: e, xhr: l})
                        }
                    })
                }
            }
            ...
            if (e = i(e), e.hasClass("resizable")) {
                e.css({height: ""});
                var a = e[0].offsetHeight, t = a - e[0].clientHeight, r = e[0].scrollHeight;
                if (r + t > a) {
                    var n = r + t;
                    e.css("height", n + "px")
                }
            ...
            e.find(".item-input").each(function () {
                var e = i(this), a = ["checkbox", "button", "submit", "range", "radio", "image"];
                e.find("input, select, textarea").each(function () {
                    var t = i(this);
            ...
            function a(e) {
                var a = i(this), t = a.val(), n = a.attr("type");
                if (!(r.indexOf(n) >= 0)) {
            ...
            if (0 !== r.pushStateQueue.length) {
                ...
                !0 === r.params.pushStateNoAnimation && (e = !1), "back" === a.action && r.router.back(a.view, {animatePages: e}), "loadPage" === a.action && r.router.load(a.view, {
                    url: a.stateUrl,
                    animatePages: e,
                    pushState: !1
                ...
                if (!a) {
                    ...
                    if (t) {
                        ...
                        if (n || (n = {viewIndex: r.views.indexOf(t), url: t.history[0]}), !(n.viewIndex < 0)) {
                            var i, s = r.views[n.viewIndex], o = n && n.url || void 0, l = n && n.content || void 0, p = n && n.pageName || void 0;
                            !0 === r.params.pushStateNoAnimation && (i = !1), o !== s.url && (s.history.indexOf(o) >= 0 ? s.allowPageChange ? r.router.back(s, {
                                ...
                                animatePages: i,
                                pushState: !1
                            }) : r.pushStateQueue.unshift({action: "loadPage", stateUrl: o, view: s}))
                        }
                    }
                }
            }
        ...
        var g = function (e) {
            ...
            a.activeIndex = a.params.initialSlide, a.openIndex = a.activeIndex, a.opened = !1, a.open = function (e) {
                ...
                var t = e.activeIndex + 1, r = e.slides.length;
            ...
            return a.swipeCloseTouchStart = function (e, a) {
                ...
                y = !1, C = !1;
                var n = Math.abs(h), i = (new Date).getTime() - b;
        ...
        var v = function (e) {
            function a(e) {
                ...
                o.params.source && o.params.source(o, a, function (e) {
                    var t = "", r = o.params.limit ? Math.min(o.params.limit, e.length) : e.length;
                    o.items = e;
                    var n, i;
                    for (o.params.highlightMatches && (a = a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), i = new RegExp("(" + a + ")", "i")), n = 0; n < r; n++) {
                        var s = "object" == typeof e[n] ? e[n][o.params.valueProperty] : e[n], l = "object" != typeof e[n] ? e[n] : e[n][o.params.textProperty];
                        t += o.dropdownItemTemplate({
                            value: s,
                            text: o.params.highlightMatches ? l.replace(i, "<b>$1</b>") : l
                        })
                    }
                    "" === t && "" === a && o.params.dropdownPlaceholderText && (t += o.dropdownPlaceholderTemplate({text: o.params.dropdownPlaceholderText})), o.dropdown.find("ul").html(t)
                })
            }

            function t(e) {
                for (var a, t = i(this), r = 0; r < o.items.length; r++) {
                    var n = "object" == typeof o.items[r] ? o.items[r][o.params.valueProperty] : o.items[r], s = t.attr("data-value");
            ...
            if (!o.params.input || (o.input = i(o.params.input), 0 !== o.input.length || "dropdown" !== o.params.openIn)) {
                ...
                if ("dropdown" !== o.params.openIn) {
                    ...
                    var u, h, f = "autocomplete-" + o.inputName, g = o.params.navbarTheme, v = o.params.formTheme, b = "", w = "";
                ...
                return o.popup = void 0, o.dropdown = void 0, o.positionDropDown = function () {
                    ...
                    function a(e) {
                        if (o.params.source) {
                            ...
                            o.params.source(o, e, function (r) {
                                var n = "", i = o.params.limit ? Math.min(o.params.limit, r.length) : r.length;
                                for (o.items = r, a = 0; a < i; a++) {
                                    var l = !1, p = "object" == typeof r[a] ? r[a][o.params.valueProperty] : r[a];
                    ...
                    if (o.page = i(n.container), o.pageData = n, n.name === f) {
                        var s = i(n.container), l = r.searchbar(s.find(".searchbar"), {
                            customSearch: !0,
                        ...
                        o.searchbar = l, !o.params.multiple && o.params.backOnSelect && s.once("click", ".list-block label", function () {
                            "popup" === o.params.openIn ? r.closeModal(o.popup) : d.router.back({animatePages: o.params.openWithAnimation})
                        }), s.on("change", 'input[type="radio"], input[type="checkbox"]', function () {
                            var e, a, r, n, s = this, l = s.value, p = (i(s).parents("li").find(".item-title").text(), i(s).parents(".autocomplete-values").length > 0);
                            if (p) {
                                ...
                                if ("radio" === o.inputType)o.value = [a]; else if (s.checked)o.value.push(a); else for (e = 0; e < o.value.length; e++)(n = "string" == typeof o.value[e] ? o.value[e] : o.value[e][o.params.valueProperty]) !== l && 1 * n != 1 * l || o.value.splice(e, 1);
                    ...
                    if (!o.opened)if (o.opened = !0, "dropdown" === o.params.openIn) {
        ...
        var b = function (e) {
            ...
            function s(e) {
                if (e.preventDefault(), !p.opened && (p.open(), p.params.scrollToInput && !a())) {
                    ...
                    var r, n = parseInt(t.css("padding-top"), 10), i = parseInt(t.css("padding-bottom"), 10), s = t[0].offsetHeight - n - p.container.height(), o = t[0].scrollHeight - n - p.container.height(), l = p.input.offset().top - n + p.input[0].offsetHeight;
                    if (l > s) {
                        var d = t.scrollTop() + l - s;
                        d + s > o && (r = d + s - o + i, s === o && (r = p.container.height()), t.css({"padding-bottom": r + "px"})), t.scrollTop(d, 300)
                    }
                }
            }
            ...
            function l() {
                p.opened = !1, p.input && p.input.length > 0 && (p.input.parents(".page-content").css({"padding-bottom": ""}), r.params.material && p.input.trigger("blur")), p.params.onClose && p.params.onClose(p), p.container.find(".picker-items-col").each(function () {
            ...
            return p.setValue = function (e, a) {
                ...
                var a, t, r = e || [], n = [];
                if (0 === p.cols.length)for (a = 0; a < p.params.cols.length; a++)t = p.params.cols[a], void 0 !== t.displayValues && void 0 !== t.values && void 0 !== t.values.indexOf(r[a]) ? n.push(t.displayValues[t.values.indexOf(r[a])]) : n.push(r[a]); else for (a = 0; a < p.cols.length; a++)p.cols[a].divider || (r.push(p.cols[a].value), n.push(p.cols[a].displayValue));
                ...
                function n(e) {
                    y || C || (e.preventDefault(), C = !0, x = T = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, k = (new Date).getTime(), L = !0, S = I = i.getTranslate(u.wrapper[0], "y"))
                }

                function s(e) {
                    if (C) {
                        e.preventDefault(), L = !1, T = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, y || (i.cancelAnimationFrame(w), y = !0, S = I = i.getTranslate(u.wrapper[0], "y"), u.wrapper.transition(0));
                        I = S + (T - x), M = void 0, I < v && (I = v - Math.pow(v - I, .8), M = "min"), I > b && (I = b + Math.pow(I - b, .8), M = "max"), u.wrapper.transform("translate3d(0," + I + "px,0)"), u.updateItems(void 0, I, 0, p.params.updateValuesOnTouchmove), O = I - E || I, D = (new Date).getTime(), E = I
                    }
                }
                ...
                function o(e) {
                    ...
                    var a;
                    P - k > 300 ? a = I : (Math.abs(O / (P - D)), a = I + O * p.params.momentumRatio), a = Math.max(Math.min(a, b), v);
                ...
                var d = i(e), c = d.index(), u = p.cols[c];
                if (!u.divider) {
                    ...
                    u.calcSize = function () {
                        p.params.rotateEffect && (u.container.removeClass("picker-items-col-absolute"), u.width || u.container.css({width: ""}));
                        var e, a;
                        e = 0, a = u.container[0].offsetHeight, h = u.wrapper[0].offsetHeight, f = u.items[0].offsetHeight, g = f * u.items.length, v = a / 2 - g + f / 2, b = a / 2 - f / 2, u.width && (e = u.width, parseInt(e, 10) === e && (e += "px"), u.container.css({width: e})), p.params.rotateEffect && (u.width || (u.items.each(function () {
                            var a = i(this).children("span");
                            e = Math.max(e, a[0].offsetWidth)
                        }), u.container.css({width: e + 2 + "px"})), u.container.addClass("picker-items-col-absolute"))
                    ...
                    u.setValue = function (e, a, r) {
                        ...
                        if (p.params.rotateEffect) {
                            ...
                            u.items.each(function () {
                                var e = i(this), t = e.index() * f, r = b - a, n = t - r, s = n / f, o = Math.ceil(u.height / f / 2) + 1, l = -18 * s;
                    ...
                    var C, y, x, T, k, P, S, M, I, E, O, D, L = !0;
                    u.initEvents = function (e) {
                        var a = e ? "off" : "on", t = !!r.support.passiveListener && {passive: !1, capture: !1};
                ...
                var t = "", r = "";
                if (e.divider)r += '<div class="picker-items-col picker-items-col-divider ' + (e.textAlign ? "picker-items-col-" + e.textAlign : "") + " " + (e.cssClass || "") + '">' + e.content + "</div>"; else {
        ...
        var w = function (e) {
            ...
            function n(e) {
                e = new Date(e);
                var a = e.getFullYear(), t = e.getMonth(), r = t + 1, n = e.getDate(), i = e.getDay();
            ...
            function s(e) {
                if (e.preventDefault(), !p.opened && (p.open(), p.params.scrollToInput && !a() && !r.params.material)) {
                    var t = p.input.parents(".page-content");
                    if (0 === t.length)return;
                    var n, i = parseInt(t.css("padding-top"), 10), s = parseInt(t.css("padding-bottom"), 10), o = t[0].offsetHeight - i - p.container.height(), l = t[0].scrollHeight - i - p.container.height(), d = p.input.offset().top - i + p.input[0].offsetHeight;
                    if (d > o) {
            ...
            function l() {
                p.opened = !1, p.input && p.input.length > 0 && (p.input.parents(".page-content").css({"padding-bottom": ""}), r.params.material && p.input.trigger("blur")), p.params.onClose && p.params.onClose(p), p.destroyCalendarEvents()
            }
            ...
            return p.animating = !1, p.addValue = function (e) {
                ...
                if (p.container && p.container.length > 0) {
                    ...
                    var s;
                    if (p.params.rangePicker && 2 === p.value.length)for (a = new Date(p.value[0]).getTime(); a <= new Date(p.value[1]).getTime(); a += 864e5)s = new Date(a), p.wrapper.find('.picker-calendar-day[data-date="' + s.getFullYear() + "-" + s.getMonth() + "-" + s.getDate() + '"]').addClass("picker-calendar-day-selected"); else for (a = 0; a < p.value.length; a++)s = new Date(p.value[a]), p.wrapper.find('.picker-calendar-day[data-date="' + s.getFullYear() + "-" + s.getMonth() + "-" + s.getDate() + '"]').addClass("picker-calendar-day-selected")
                }
                ...
                function n(e) {
                    if (T) {
                        ...
                        if (0 === a.length && i(e.target).hasClass("picker-calendar-day") && (a = i(e.target)), 0 !== a.length && !a.hasClass("picker-calendar-day-disabled")) {
                            ...
                            var t = a.attr("data-year"), r = a.attr("data-month"), n = a.attr("data-day");
                ...
                var k = !("touchstart" !== r.touchEvents.start || !r.support.passiveListener) && {
                        passive: !0,
                        capture: !1
                    }, P = !!r.support.passiveListener && {passive: !1, capture: !1};
                ...
                if (!a)return !1
                    ;
                if (Array.isArray(a))for (t = 0; t < a.length; t++)a[t].from || a[t].to ? a[t].from && a[t].to ? e <= new Date(a[t].to).getTime() && e >= new Date(a[t].from).getTime() && (r = !0) : a[t].from ? e >= new Date(a[t].from).getTime() && (r = !0) : a[t].to && e <= new Date(a[t].to).getTime() && (r = !0) : e === new Date(a[t]).getTime() && (r = !0); else a.from || a.to ? a.from && a.to ? e <= new Date(a.to).getTime() && e >= new Date(a.from).getTime() && (r = !0) : a.from ? e >= new Date(a.from).getTime() && (r = !0) : a.to && e <= new Date(a.to).getTime() && (r = !0) : "function" == typeof a && (r = a(new Date(e)));
                return r
                ...
                e = new Date(e);
                var t = e.getFullYear(), r = e.getMonth();
                e.getDate();
                ...
                var n = p.daysInMonth(new Date(e.getFullYear(), e.getMonth()).getTime() - 864e6), i = p.daysInMonth(e), s = new Date(e.getFullYear(), e.getMonth()).getDay();
                0 === s && (s = 7);
                var o, l, d, c, m, u, h = [], f = "", g = p.params.firstDay - 1 + 0, v = (new Date).setHours(0, 0, 0, 0), b = p.params.minDate ? new Date(p.params.minDate).getTime() : null, w = p.params.maxDate ? new Date(p.params.maxDate).getTime() : null;
                if (p.value && p.value.length)for (l = 0; l < p.value.length; l++)h.push(new Date(p.value[l]).setHours(0, 0, 0, 0));
                for (l = 1; l <= 6; l++) {
                    var C = "";
                    for (d = 1; d <= 7; d++) {
                        var y = d;
                        g++;
                        var x = g - s, T = y - 1 + p.params.firstDay > 6 ? y - 1 - 7 + p.params.firstDay : y - 1 + p.params.firstDay, k = "";
                        ...
                        var P = o.getFullYear(), S = o.getMonth();
                ...
                var a = 100 * -(e + 1) * m, t = 100 * -e * m, r = 100 * -(e - 1) * m;
                ...
                var a = parseInt(p.months.eq(p.months.length - 1).attr("data-month"), 10), t = parseInt(p.months.eq(p.months.length - 1).attr("data-year"), 10), r = new Date(t, a), n = r.getTime(), s = !p.animating;
                if (p.params.maxDate && n > new Date(p.params.maxDate).getTime())return p.resetMonth();
                if (p.monthsTranslate--, a === p.currentMonth) {
                    var o = 100 * -p.monthsTranslate * m, l = i(p.monthHTML(n, "next")).transform("translate3d(" + (p.isH ? o : 0) + "%, " + (p.isH ? 0 : o) + "%, 0)").addClass("picker-calendar-month-next");
                ...
                void 0 !== e && "object" != typeof e || (e = "", p.params.animate || (e = 0));
                var a = parseInt(p.months.eq(0).attr("data-month"), 10), t = parseInt(p.months.eq(0).attr("data-year"), 10), r = new Date(t, a + 1, -1), n = r.getTime(), s = !p.animating;
                if (p.params.minDate && n < new Date(p.params.minDate).getTime())return p.resetMonth();
                if (p.monthsTranslate++, a === p.currentMonth) {
                    var o = 100 * -p.monthsTranslate * m, l = i(p.monthHTML(n, "prev")).transform("translate3d(" + (p.isH ? o : 0) + "%, " + (p.isH ? 0 : o) + "%, 0)").addClass("picker-calendar-month-prev");
                ...
                var n = new Date(p.currentYear, p.currentMonth).getTime(), i = r > n ? "next" : "prev", s = p.monthHTML(new Date(e, a));
                p.monthsTranslate = p.monthsTranslate || 0;
                var o, l, d = p.monthsTranslate, c = !p.animating;
                ...
                var e, a = "", t = "", r = p.value && p.value.length ? p.value[0] : (new Date).setHours(0, 0, 0, 0), n = p.monthHTML(r, "prev"), i = p.monthHTML(r), s = p.monthHTML(r, "next"), o = '<div class="picker-calendar-months"><div class="picker-calendar-months-wrapper">' + (n + i + s) + "</div></div>", l = "";
        ...
        r.addNotification = function (e) {
            ...
            if (e = i(e), 0 !== e.length && !e.hasClass("notification-item-removing")) {
                var t = i(".notifications"), r = e.outerHeight();
            ...
            function a() {
                if (t.length > 0 && r.length > 0) {
                    ...
                    e[a > 0 ? "addClass" : "removeClass"]("data-table-has-checked"), r.find(".data-table-selected-count").text(a)
                }
            }

            e = i(e);
            var t = e.find(".data-table-header"), r = e.find(".data-table-header-selected");
            e.on("change", '.checkbox-cell input[type="checkbox"]', function (t) {
                if (!t.detail || !t.detail._sentByF7DataTable) {
                    var r = i(this), n = r[0].checked;
                    r.parents("thead").length > 0 ? e.find("tbody tr")[n ? "addClass" : "removeClass"]("data-table-row-selected").find("input").prop("checked", n).trigger("change", {_sentByF7DataTable: !0}) : (r.parents("tr")[n ? "addClass" : "removeClass"]("data-table-row-selected"), n ? e.find('tbody .checkbox-cell input[type="checkbox"]:checked').length === e.find("tbody tr").length && e.find('thead .checkbox-cell input[type="checkbox"]').prop("checked", !0).trigger("change", {_sentByF7DataTable: !0}) : e.find('thead .checkbox-cell input[type="checkbox"]').prop("checked", !1)), a()
                }
            }), a(), e.find("thead .sortable-cell").on("click", function () {
                var a, t = i(this), r = t.hasClass("sortable-active");
                ...
                var a = i(this).index(), t = i(this).attr("data-collapsible-title");
        ...
        var e = {}, a = navigator.userAgent, t = Dom7, r = a.match(/(Windows Phone);?[\s\/]+([\d.]+)?/), n = a.match(/(Android);?[\s\/]+([\d.]+)?/), i = a.match(/(iPad).*OS\s([\d_]+)/), s = a.match(/(iPod)(.*OS\s([\d_]+))?/), o = !i && a.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
        ...
        var p = t(window).width(), d = t(window).height();
        e.needsStatusBar = function () {
            return !(!e.webView || p * d != screen.width * screen.height)
        }, e.statusBar = e.needsStatusBar();
        var c = [];
        if (e.pixelRatio = window.devicePixelRatio || 1, c.push("pixel-ratio-" + Math.floor(e.pixelRatio)), e.pixelRatio >= 2 && c.push("retina"), e.os && (c.push(e.os, e.os + "-" + e.osVersion.split(".")[0], e.os + "-" + e.osVersion.replace(/\./g, "-")), "ios" === e.os))for (var m = parseInt(e.osVersion.split(".")[0], 10), u = m - 1; u >= 6; u--)c.push("ios-gt-" + u);
        ...
        a = a || {};
        var d = {};
        for (var c in a)if ("object" != typeof a[c] || null === a[c] || (a[c].nodeType || a[c] === window || a[c] === document || "undefined" != typeof Dom7 && a[c] instanceof Dom7 || "undefined" != typeof jQuery && a[c] instanceof jQuery))d[c] = a[c]; else {
            d[c] = {};
            for (var m in a[c])d[c][m] = a[c][m]
        }
        for (var u in l)if (void 0 === a[u])a[u] = l[u]; else if ("object" == typeof a[u])for (var h in l[u])void 0 === a[u][h] && (a[u][h] = l[u][h]);
        var f = this;
        ...
        if (void 0 !== g && "undefined" != typeof Dom7 && (g = Dom7), (void 0 !== g || (g = "undefined" == typeof Dom7 ? window.Dom7 || window.Zepto || window.jQuery : Dom7)) && (f.$ = g, f.currentBreakpoint = void 0, f.getActiveBreakpoint = function () {
                ...
                if (e && f.currentBreakpoint !== e) {
                    var a = e in f.params.breakpoints ? f.params.breakpoints[e] : f.originalParams, t = f.params.loop && a.slidesPerView !== f.params.slidesPerView;
            ...
            f.container[0].swiper = f, f.container.data("swiper", f), f.classNames.push(f.params.containerModifierClass + f.params.direction), f.params.freeMode && f.classNames.push(f.params.containerModifierClass + "free-mode"), f.support.flexbox || (f.classNames.push(f.params.containerModifierClass + "no-flexbox"), f.params.slidesPerColumn = 1), f.params.autoHeight && f.classNames.push(f.params.containerModifierClass + "autoheight"), (f.params.parallax || f.params.watchSlidesVisibility) && (f.params.watchSlidesProgress = !0), f.params.touchReleaseOnEdges && (f.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(f.params.effect) >= 0 && (f.support.transforms3d ? (f.params.watchSlidesProgress = !0, f.classNames.push(f.params.containerModifierClass + "3d")) : f.params.effect = "slide"), "slide" !== f.params.effect && f.classNames.push(f.params.containerModifierClass + f.params.effect), "cube" === f.params.effect && (f.params.resistanceRatio = 0, f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.centeredSlides = !1, f.params.spaceBetween = 0, f.params.virtualTranslate = !0), "fade" !== f.params.effect && "flip" !== f.params.effect || (f.params.slidesPerView = 1, f.params.slidesPerColumn = 1, f.params.slidesPerGroup = 1, f.params.watchSlidesProgress = !0, f.params.spaceBetween = 0, void 0 === p && (f.params.virtualTranslate = !0)), f.params.grabCursor && f.support.touch && (f.params.grabCursor = !1), f.wrapper = f.container.children("." + f.params.wrapperClass), f.params.pagination && (f.paginationContainer = g(f.params.pagination), f.params.uniqueNavElements && "string" == typeof f.params.pagination && f.paginationContainer.length > 1 && 1 === f.container.find(f.params.pagination).length && (f.paginationContainer = f.container.find(f.params.pagination)), "bullets" === f.params.paginationType && f.params.paginationClickable ? f.paginationContainer.addClass(f.params.paginationModifierClass + "clickable") : f.params.paginationClickable = !1, f.paginationContainer.addClass(f.params.paginationModifierClass + f.params.paginationType)), (f.params.nextButton || f.params.prevButton) && (f.params.nextButton && (f.nextButton = g(f.params.nextButton), f.params.uniqueNavElements && "string" == typeof f.params.nextButton && f.nextButton.length > 1 && 1 === f.container.find(f.params.nextButton).length && (f.nextButton = f.container.find(f.params.nextButton))), f.params.prevButton && (f.prevButton = g(f.params.prevButton), f.params.uniqueNavElements && "string" == typeof f.params.prevButton && f.prevButton.length > 1 && 1 === f.container.find(f.params.prevButton).length && (f.prevButton = f.container.find(f.params.prevButton)))), f.isHorizontal = function () {
                ...
                !0 === f.params.allowSwipeToNext && f.params.grabCursor && f.setGrabCursor()
                ...
                var e, a = f.params.spaceBetween, r = -f.params.slidesOffsetBefore, n = 0, i = 0;
                if (void 0 !== f.size) {
                    "string" == typeof a && a.indexOf("%") >= 0 && (a = parseFloat(a.replace("%", "")) / 100 * f.size), f.virtualSize = -a, f.rtl ? f.slides.css({
                        marginLeft: "",
                        marginTop: ""
                    }) : f.slides.css({marginRight: "", marginBottom: ""});
                    var s;
                    ...
                    var o, l = f.params.slidesPerColumn, p = s / l, d = p - (f.params.slidesPerColumn * p - f.slides.length);
                    ...
                    0 === f.snapGrid.length && (f.snapGrid = [0]), 0 !== f.params.spaceBetween && (f.isHorizontal() ? f.rtl ? f.slides.css({marginLeft: a + "px"}) : f.slides.css({marginRight: a + "px"}) : f.slides.css({marginBottom: a + "px"})), f.params.watchSlidesProgress && f.updateSlidesOffset()
                }
                ...
                } else for (e = f.activeIndex + 1; e < f.slides.length; e++)f.slidesGrid[e] - f.slidesGrid[f.activeIndex] < f.size && t++;
                return t
                ...
                if (void 0 === e && (e = f.translate || 0), 0 !== f.slides.length) {
                    ...
                    for (var t = 0; t < f.slides.length; t++) {
                        var r = f.slides[t], n = (a + (f.params.centeredSlides ? f.minTranslate() : 0) - r.swiperSlideOffset) / (r.swiperSlideSize + f.params.spaceBetween);
                        if (f.params.watchSlidesVisibility) {
                            var i = -(a - r.swiperSlideOffset), s = i + f.slidesSizesGrid[t];
                ...
                var a = f.maxTranslate() - f.minTranslate(), t = f.isBeginning, r = f.isEnd;
                ...
                var a = f.params.allowSwipeToPrev, t = f.params.allowSwipeToNext;
                ...
                var t = e ? "off" : "on", r = e ? "removeEventListener" : "addEventListener", n = "container" === f.params.touchEventsTarget ? f.container[0] : f.wrapper[0], i = f.support.touch ? n : document, s = !!f.params.nested;
                if (f.browser.ie)n[r](f.touchEvents.start, f.onTouchStart, !1), i[r](f.touchEvents.move, f.onTouchMove, s), i[r](f.touchEvents.end, f.onTouchEnd, !1); else {
                    if (f.support.touch) {
                ...
                var a = n(e, "." + f.params.slideClass), t = !1;
                if (a)for (var r = 0; r < f.slides.length; r++)f.slides[r] === a && (t = !0);
                ...
                if (f.clickedSlide = a, f.clickedIndex = g(a).index(), f.params.slideToClickedSlide && void 0 !== f.clickedIndex && f.clickedIndex !== f.activeIndex) {
                    var i, s = f.clickedIndex, o = "auto" === f.params.slidesPerView ? f.currentSlidesPerView() : f.params.slidesPerView;
                    if (f.params.loop) {
            ...
            var b, w, C, y, x, T, k, P, S, M, I = "input, select, textarea, button, video", E = Date.now(), O = [];
            ...
            f.onTouchStart = function (e) {
                if (e.originalEvent && (e = e.originalEvent), (D = "touchstart" === e.type) || !("which" in e) || 3 !== e.which) {
                    ...
                    if (!f.params.swipeHandler || n(e, f.params.swipeHandler)) {
                        var a = f.touches.currentX = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, t = f.touches.currentY = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY;
                        if (!(f.device.ios && f.params.iOSEdgeSwipeDetection && a <= f.params.iOSEdgeSwipeThreshold)) {
                            if (b = !0, w = !1, C = !0, x = void 0, L = void 0, f.touches.startX = a, f.touches.startY = t, y = Date.now(), f.allowClick = !0, f.updateContainerSize(), f.swipeDirection = void 0, f.params.threshold > 0 && (P = !1), "touchstart" !== e.type) {
                                var r = !0;
                ...
                if (e.originalEvent && (e = e.originalEvent), !D || "mousemove" !== e.type) {
                    ...
                    if (D && f.params.touchReleaseOnEdges && !f.params.loop)if (f.isHorizontal()) {
                    ...
                    if (D && document.activeElement && e.target === document.activeElement && g(e.target).is(I))return w = !0, void(f.allowClick = !1);
                    if (C && f.emit("onTouchMove", f, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                        ...
                        if (x && f.emit("onTouchMoveOpposite", f, e), void 0 === L && (f.touches.currentX === f.touches.startX && f.touches.currentY === f.touches.startY || (L = !0)), b) {
                ...
                if (e.originalEvent && (e = e.originalEvent), C && f.emit("onTouchEnd", f, e), C = !1, b) {
                    ...
                    if (r = f.params.followFinger ? f.rtl ? f.translate : -f.translate : -T, f.params.freeMode) {
                        ...
                        if (f.params.freeModeMomentum) {
                            if (O.length > 1) {
                                var n = O.pop(), i = O.pop(), s = n.position - i.position, o = n.time - i.time;
                            ...
                            f.rtl && (d = -d);
                            var c, m = !1, u = 20 * Math.abs(f.velocity) * f.params.freeModeMomentumBounceRatio;
                            if (d < f.maxTranslate())f.params.freeModeMomentumBounce ? (d + f.maxTranslate() < -u && (d = f.maxTranslate() - u), c = f.maxTranslate(), m = !0, M = !0) : d = f.maxTranslate(); else if (d > f.minTranslate())f.params.freeModeMomentumBounce ? (d - f.minTranslate() > u && (d = f.minTranslate() + u), c = f.minTranslate(), m = !0, M = !0) : d = f.minTranslate(); else if (f.params.freeModeSticky) {
                                var h, v = 0;
                                for (v = 0; v < f.snapGrid.length; v += 1)if (f.snapGrid[v] > -d) {
                                    h = v;
                                    break
                                }
                                d = Math.abs(f.snapGrid[h] - d) < Math.abs(f.snapGrid[h - 1] - d) || "next" === f.swipeDirection ? f.snapGrid[h] : f.snapGrid[h - 1], f.rtl || (d = -d)
                            }
                            if (0 !== f.velocity)l = f.rtl ? Math.abs((-d - f.translate) / f.velocity) : Math.abs((d - f.translate) / f.velocity); else if (f.params.freeModeSticky)return void f.slideReset();
                    ...
                    var x, P = 0, I = f.slidesSizesGrid[0];
                    ...
                    var D = (r - f.slidesGrid[P]) / I;
                    if (t > f.params.longSwipesMs) {
                        if (!f.params.longSwipes)return void f.slideTo(f.activeIndex);
                        "next" === f.swipeDirection && (D >= f.params.longSwipesRatio ? f.slideTo(P + f.params.slidesPerGroup) : f.slideTo(P)), "prev" === f.swipeDirection && (D > 1 - f.params.longSwipesRatio ? f.slideTo(P + f.params.slidesPerGroup) : f.slideTo(P))
                    } else {
                ...
                if (f.params.autoplay && f.autoplaying && (r || !f.params.autoplayDisableOnInteraction ? f.pauseAutoplay(a) : f.stopAutoplay()), f.updateProgress(n), f.params.normalizeSlideIndex)for (var i = 0; i < f.slidesGrid.length; i++)-Math.floor(100 * n) >= Math.floor(100 * f.slidesGrid[i]) && (e = i);
                ...
                var t, r, n, i;
                return void 0 === a && (a = "x"),
                    f.params.virtualTranslate ? f.rtl ? -f.translate : f.translate : (n = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? (r = n.transform || n.webkitTransform, r.split(",").length > 6 && (r = r.split(", ").map(function (e) {
                        return e.replace(",", ".")
                ...
                fade: {
                    setTranslate: function () {
                        for (var e = 0; e < f.slides.length; e++) {
                            var a = f.slides.eq(e), t = a[0].swiperSlideOffset, r = -t;
                            ...
                            a.css({opacity: i}).transform("translate3d(" + r + "px, " + n + "px, 0px)")
                        }
                    ...
                    setTranslate: function () {
                        for (var e = 0; e < f.slides.length; e++) {
                            var a = f.slides.eq(e), t = a[0].progress;
                            f.params.flip.limitRotation && (t = Math.max(Math.min(a[0].progress, 1), -1));
                            var r = a[0].swiperSlideOffset, n = -180 * t, i = n, s = 0, o = -r, l = 0;
                            if (f.isHorizontal() ? f.rtl && (i = -i) : (l = o, o = 0, s = -i, i = 0), a[0].style.zIndex = -Math.abs(Math.round(t)) + f.slides.length, f.params.flip.slideShadows) {
                                var p = f.isHorizontal() ? a.find(".swiper-slide-shadow-left") : a.find(".swiper-slide-shadow-top"), d = f.isHorizontal() ? a.find(".swiper-slide-shadow-right") : a.find(".swiper-slide-shadow-bottom");
                    ...
                    setTranslate: function () {
                        var e, a = 0;
                        f.params.cube.shadow && (f.isHorizontal() ? (e = f.wrapper.find(".swiper-cube-shadow"), 0 === e.length && (e = g('<div class="swiper-cube-shadow"></div>'), f.wrapper.append(e)), e.css({height: f.width + "px"})) : (e = f.container.find(".swiper-cube-shadow"), 0 === e.length && (e = g('<div class="swiper-cube-shadow"></div>'), f.container.append(e))));
                        for (var t = 0; t < f.slides.length; t++) {
                            var r = f.slides.eq(t), n = 90 * t, i = Math.floor(n / 360);
                            f.rtl && (n = -n, i = Math.floor(-n / 360));
                            var s = Math.max(Math.min(r[0].progress, 1), -1), o = 0, l = 0, p = 0;
                            ...
                            if (s <= 1 && s > -1 && (a = 90 * t + 90 * s, f.rtl && (a = 90 * -t - 90 * s)), r.transform(d), f.params.cube.slideShadows) {
                                var c = f.isHorizontal() ? r.find(".swiper-slide-shadow-left") : r.find(".swiper-slide-shadow-top"), m = f.isHorizontal() ? r.find(".swiper-slide-shadow-right") : r.find(".swiper-slide-shadow-bottom");
                        ...
                        if (f.wrapper.css({
                            ...
                            }), f.params.cube.shadow)if (f.isHorizontal())e.transform("translate3d(0px, " + (f.width / 2 + f.params.cube.shadowOffset) + "px, " + -f.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + f.params.cube.shadowScale + ")"); else {
                            var u = Math.abs(a) - 90 * Math.floor(Math.abs(a) / 90), h = 1.5 - (Math.sin(2 * u * Math.PI / 360) / 2 + Math.cos(2 * u * Math.PI / 360) / 2), v = f.params.cube.shadowScale, b = f.params.cube.shadowScale / h, w = f.params.cube.shadowOffset;
                    ...
                    setTranslate: function () {
                        for (var e = f.translate, a = f.isHorizontal() ? -e + f.width / 2 : -e + f.height / 2, t = f.isHorizontal() ? f.params.coverflow.rotate : -f.params.coverflow.rotate, r = f.params.coverflow.depth, n = 0, i = f.slides.length; n < i; n++) {
                            var s = f.slides.eq(n), o = f.slidesSizesGrid[n], l = s[0].swiperSlideOffset, p = (a - l - o / 2) / o * f.params.coverflow.modifier, d = f.isHorizontal() ? t * p : 0, c = f.isHorizontal() ? 0 : t * p, m = -r * Math.abs(p), u = f.isHorizontal() ? 0 : f.params.coverflow.stretch * p, h = f.isHorizontal() ? f.params.coverflow.stretch * p : 0;
                            ...
                            if (s.transform(v), s[0].style.zIndex = 1 - Math.abs(Math.round(p)), f.params.coverflow.slideShadows) {
                                var b = f.isHorizontal() ? s.find(".swiper-slide-shadow-left") : s.find(".swiper-slide-shadow-top"), w = f.isHorizontal() ? s.find(".swiper-slide-shadow-right") : s.find(".swiper-slide-shadow-bottom");
                ...
                initialImageLoaded: !1, loadImageInSlide: function (e, a) {
                    if (void 0 !== e && (void 0 === a && (a = !0), 0 !== f.slides.length)) {
                        var t = f.slides.eq(e), r = t.find("." + f.params.lazyLoadingClass + ":not(." + f.params.lazyStatusLoadedClass + "):not(." + f.params.lazyStatusLoadingClass + ")");
                        !t.hasClass(f.params.lazyLoadingClass) || t.hasClass(f.params.lazyStatusLoadedClass) || t.hasClass(f.params.lazyStatusLoadingClass) || (r = r.add(t[0])), 0 !== r.length && r.each(function () {
                            ...
                            var r = e.attr("data-background"), n = e.attr("data-src"), i = e.attr("data-srcset"), s = e.attr("data-sizes");
                    ...
                    }); else if (a > 1)for (e = f.activeIndex; e < f.activeIndex + a; e++)f.slides[e] && f.lazy.loadImageInSlide(e); else f.lazy.loadImageInSlide(f.activeIndex);
                    if (f.params.lazyLoadingInPrevNext)if (a > 1 || f.params.lazyLoadingInPrevNextAmount && f.params.lazyLoadingInPrevNextAmount > 1) {
                        var t = f.params.lazyLoadingInPrevNextAmount, r = a, n = Math.min(f.activeIndex + r + Math.max(t, r), f.slides.length), i = Math.max(f.activeIndex - Math.max(r, t), 0);
                ...
                isTouched: !1, setDragPosition: function (e) {
                    var a = f.scrollbar, t = f.isHorizontal() ? "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX || e.clientX : "touchstart" === e.type || "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY || e.clientY, r = t - a.track.offset()[f.isHorizontal() ? "left" : "top"] - a.dragSize / 2, n = -f.minTranslate() * a.moveDivider, i = -f.maxTranslate() * a.moveDivider;
                    ...
                    var e = f.scrollbar, a = f.support.touch ? e.track : document;
                    ...
                    if (f.params.scrollbar) {
                        var e, a = f.scrollbar, t = (f.translate, a.dragSize);
                ...
                LinearSpline: function (e, a) {
                    ...
                    if (Array.isArray(i))for (var s = 0; s < i.length; s++)i[s] !== a && i[s] instanceof Swiper && t(i[s]); else i instanceof Swiper && a !== i && t(i)
                    ...
                    if (Array.isArray(n))for (r = 0; r < n.length; r++)n[r] !== a && n[r] instanceof Swiper && t(n[r]); else n instanceof Swiper && a !== n && t(n)
                }
            }, f.parallax = {
                setTranslate: function () {
                    ...
                    void 0 === e && (e = f.params.speed), f.container.find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]").each(function () {
                        var a = g(this), t = parseInt(a.attr("data-swiper-parallax-duration"), 10) || e;
                ...
                getDistanceBetweenTouches: function (e) {
                    ...
                    var a = e.targetTouches[0].pageX, t = e.targetTouches[0].pageY, r = e.targetTouches[1].pageX, n = e.targetTouches[1].pageY;
                ...
                onTouchMove: function (e) {
                    ...
                    if (a.gesture.image && 0 !== a.gesture.image.length && (f.allowClick = !1, a.image.isTouched && a.gesture.slide)) {
                        ...
                        var t = a.image.width * a.scale, r = a.image.height * a.scale;
                ...
                onTouchEnd: function (e, a) {
                    ...
                    if (t.gesture.image && 0 !== t.gesture.image.length) {
                        ...
                        var r = 300, n = 300, i = t.velocity.x * r, s = t.image.currentX + i, o = t.velocity.y * n, l = t.image.currentY + o;
                        ...
                        var d = t.image.width * t.scale, c = t.image.height * t.scale;
        ...
        device: function () {
            var e = window.navigator.userAgent, a = e.match(/(Android);?[\s\/]+([\d.]+)?/), t = e.match(/(iPad).*OS\s([\d_]+)/), r = e.match(/(iPod)(.*OS\s([\d_]+))?/), n = !t && e.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
            return {ios: t || n || r, android: a}
        }(),
        support: {
